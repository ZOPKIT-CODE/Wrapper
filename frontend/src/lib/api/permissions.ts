...
export const permissionsAPI = {
  ...
  getUserPermissions: (userId: string) =>
    api.get(`/api/permissions/users/${userId}/permissions`),
  ...
  deleteRole: (roleId: string, force: boolean = true) =>
    api.delete(`/api/permissions/roles/${roleId}`, { params: { force } }),
  ...
  getCustomUserPermissions: (userId: string) =>
    api.get(`/custom-roles/user-permissions/${userId}`),
