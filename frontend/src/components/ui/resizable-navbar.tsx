    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className={cn(
            'w-full overflow-hidden bg-transparent px-6 pt-2 pb-6',
            className
          )}
        >
...
export const NavbarButton = ({
  ...
  return (
    <Tag
      href={href || undefined}
      className={cn(
        'inline-flex items-center justify-center rounded-full border border-neutral-200 bg-transparent px-5 py-2 text-sm font-medium text-neutral-600 transition-all duration-200 hover:border-neutral-300 hover:bg-neutral-50 hover:text-neutral-900 focus:outline-none active:scale-95',
        className
      )}
      {...props}
    >
