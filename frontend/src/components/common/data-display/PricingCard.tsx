    ...
    <div className="relative flex justify-center items-center">
      {recommended && !isTopupCard && (
        <div className="absolute top-[-12px] left-1/2 -translate-x-1/2 z-20">
          <span className="bg-primary text-primary-foreground px-4 py-1.5 rounded-full text-[10px] font-bold shadow-md inline-block whitespace-nowrap uppercase tracking-wider">
            Most Popular
          </span>
        </div>
      )}
      ...
      <div className={cn(
        ...
        isPremium
          ? "bg-primary/5 border border-primary/30 shadow-[0_20px_50px_-20px_rgba(27,46,90,0.2)] hover:scale-[1.03] hover:shadow-[0_40px_80px_-30px_rgba(27,46,90,0.3)]"
        ...
        {recommended && (
          <div className="absolute w-[150px] h-[150px] -top-[10px] -right-[10px] flex items-center justify-center z-20 pointer-events-none overflow-hidden">
            <div className="absolute w-[150%] h-[34px] bg-primary rotate-45 -translate-y-4 flex items-center justify-center text-white font-black text-[10px] tracking-[0.2em] shadow-lg uppercase">
              PREMIUM
            </div>
          </div>
        )}
            ...
            {features.map((feature, index) => (
              <li key={index} className="flex items-center gap-3">
                <div className={cn(
                  ...
                  isPremium ? "bg-primary shadow-primary/20" : "bg-slate-100 shadow-slate-200/50"
                )}>
