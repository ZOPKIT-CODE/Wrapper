...
export function AppIcon({
  ...
  const icons = [
    /* CRM */
    <Users key="crm" size={size} color={stroke} strokeWidth={2.2} />,
    /* HR */
    ...
    /* Affiliate */
    <Share2 key="affiliate" size={size} color={stroke} strokeWidth={2.2} />,
    /* Ops */
    <Settings key="ops" size={size} color={stroke} strokeWidth={2.2} />,
    /* Finance */
    <Banknote key="finance" size={size} color={stroke} strokeWidth={2.2} />,
    /* Analytics */
    <svg
      key="analytics"
      width={size}
...
const getApplicationUrl = (application: Application): string => {
  ...
  return (
    urlPatterns[application.appCode] ||
    `${baseDomain}/apps/${application.appCode}`
  )
}
...
export const ApplicationCard = memo(function ApplicationCard({
  ...
  const isOperational =
    (application as { isActive?: boolean }).isActive !== false
