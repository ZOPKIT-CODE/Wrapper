...
const IconComponents = {
  crm: memo(() => <Users className="h-6 w-6" />),
  hr: memo(() => <Building className="h-6 w-6" />),
  affiliate: memo(() => <TrendingUp className="h-6 w-6" />),
  system: memo(() => <Settings className="h-6 w-6" />),
  finance: memo(() => <PieChart className="h-6 w-6" />),
  inventory: memo(() => <Package className="h-6 w-6" />),
  analytics: memo(() => <Activity className="h-6 w-6" />),
} as const
...
export const getApplicationIcon = (appCode: string) => {
  ...
  return IconComponent ? <IconComponent /> : <Package className="h-6 w-6" />
}
...
export const getStatusColor = (status: string): string => {
  ...
  return (
    statusColors[status.toLowerCase() as ApplicationStatus] ||
