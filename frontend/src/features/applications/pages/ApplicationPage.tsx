      ...
      <div>
        ...
        >
          {reply.items.map((item, i) => (
            <li
              key={i}
              style={{ paddingLeft: 14, position: 'relative', lineHeight: 1.5 }}
            >
              <span style={{ position: 'absolute', left: 0, color: '#94a3b8' }}>
                •
              </span>
              {item}
            </li>
        ...
        {reply.rows.map((row, ri) => (
          <div
            ...
            style={{
              ...
              alignItems: 'center',
              padding: '5px 10px',
              background: ri % 2 ? '#f8faff' : '#fff',
              borderBottom:
                ri < reply.rows.length - 1 ? '1px solid #f1f5f9' : 'none',
            }}
          >
            {row.map((cell, ci) => {
              ...
              return (
                <span
                  key={ci}
                  style={{
                    flex: ci === 0 ? '0 0 34px' : 1,
                    fontSize: 11,
                    color: ci === 0 ? '#94a3b8' : '#0f172a',
    ...
    >
      <div
        ...
        style={{
          ...
          fontSize: 9,
          fontWeight: 800,
          background: isUser ? '#142a5e' : '#7c3aed',
        }}
      >
        {isUser ? 'You' : 'Z'}
      </div>
...
const HeroAgentDemo = memo(function HeroAgentDemo({
  scenarios,
}: {
  scenarios: Scenario[]
}) {
    ...
    <div style={{ width: '100%', maxWidth: 640, marginLeft: 'auto' }}>
      <div
        style={{
          ...
          borderRadius: 8,
          boxShadow:
            '0 1px 0 rgba(15,28,58,0.04), 0 24px 60px rgba(15,28,58,0.12), 0 8px 20px rgba(15,28,58,0.05)',
          overflow: 'hidden',
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ color: '#e2e8f0' }} aria-hidden="true">
              ·
            </span>
          ...
          <form
            onSubmit={onSubmit}
            style={{ padding: '6px 12px 10px', flexShrink: 0 }}
          >
            <div
              className="zkm-input"
              style={{
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 6,
                  border: 'none',
                  background: input.trim() ? '#142a5e' : '#cbd5e1',
                  color: '#fff',
                  display: 'grid',
                  placeItems: 'center',
    ...
    >
      ...
      <section
        ...
        style={{
          position: 'relative',
          background:
            'radial-gradient(900px 480px at 92% 30%, #e2eefc 0%, transparent 60%), linear-gradient(180deg, #f5faff 0%, #eaf3fd 90%)',
          overflow: 'hidden',
        }}
      >
        {/* Curved white bottom */}
