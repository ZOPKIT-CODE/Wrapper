...
const ProductPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
        className={`w-full bg-white font-sans text-slate-900 selection:bg-blue-100 selection:text-blue-900 ${productId === 'financial-accounting' ? 'hidden md:block' : ''}`}
      >
        <style>{`
                              ...
                              >
                                <button
                                  ...
                                  className={`w-full rounded-lg py-3 text-sm font-bold transition-all ${
                                    idx === 1
                                      ? 'bg-[#1B2E5A] text-white shadow-lg shadow-blue-600/20 hover:bg-[#162447]'
        ...
        <section className="bg-gradient-to-b from-blue-50 to-white py-24">
          <div className="container mx-auto px-4">
            <div className="relative overflow-hidden rounded-[2.5rem] bg-slate-900 p-12 text-center shadow-2xl lg:p-24">
              <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20"></div>
              <div className="absolute top-0 right-0 -mt-20 -mr-20 h-96 w-96 rounded-full bg-blue-500/30 blur-[80px]"></div>
              <div className="absolute bottom-0 left-0 -mb-20 -ml-20 h-96 w-96 rounded-full bg-purple-500/30 blur-[80px]"></div>

              <div className="relative z-10 mx-auto max-w-3xl">
                <h2 className="mb-8 text-4xl font-bold tracking-tight text-white lg:text-6xl">
                ...
                <div className="flex flex-col justify-center gap-3 sm:flex-row">
                  <button
                    ...
                    className="group inline-flex items-center justify-center gap-2 rounded-full bg-white px-8 py-4 text-base font-semibold text-slate-900 shadow-2xl ring-1 shadow-blue-500/10 ring-white/40 transition-all duration-200 ring-inset hover:-translate-y-0.5 hover:shadow-blue-500/25"
                  >
                  ...
                  <button className="group inline-flex items-center justify-center gap-2 rounded-full border border-white/15 bg-white/5 px-8 py-4 text-base font-semibold text-white backdrop-blur-sm transition-all duration-200 hover:border-white/25 hover:bg-white/10">
                    <Calendar
                      size={15}
                      strokeWidth={2.25}
