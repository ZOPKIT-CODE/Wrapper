...
export function getCRMFeatureSvg(i: number): React.ReactNode {
  ...
  const Tr = (y: number, even: boolean, x = 36, w = 752) => (
    <rect
      ...
      height="32"
      rx="3"
      fill={even ? W : 'var(--illustration-panel)'}
      stroke={BD}
      strokeWidth="0.5"
    />
  )
    ...
    case 0:
      return (
        ...
        >
          ...
          {Hdr(
            'Leads',
            '47 active leads · $2.4M weighted pipeline',
            '+ Add Lead'
          )}
            ...
            [
              {
                name: 'New',
                count: '15',
                color: 'var(--illustration-info)',
                bg: 'var(--illustration-info-bg)',
              },
              {
                name: 'Contacted',
                count: '12',
                color: 'var(--chart-4)',
                bg: 'color-mix(in oklch, var(--chart-4) 8%, var(--background))',
              },
              {
                name: 'Qualified',
                count: '10',
                color: 'var(--illustration-warning)',
                bg: 'color-mix(in oklch, var(--illustration-warning) 10%, var(--background))',
              },
              {
                name: 'Proposal',
                count: '10',
                color: 'var(--illustration-success)',
                bg: 'var(--illustration-success-tint)',
              },
            ] as const
          ).map((col, ci) => (
            <g key={ci}>
          ...
          {[
            ...
            <g key={ci}>
              ...
              <rect
                ...
                fill={
                  c.score >= 80
                    ? 'var(--illustration-success-tint)'
                    : c.score >= 70
                      ? 'color-mix(in oklch, var(--illustration-warning) 10%, var(--background))'
                      : 'var(--illustration-panel-alt)'
                }
              />
              {T(
                186 + c.col * 190,
                ...
                true,
                c.score >= 80
                  ? 'var(--illustration-success)'
                  : c.score >= 70
                    ? 'var(--illustration-warning)'
    ...
    case 1:
      return (
        ...
        >
          ...
          {Hdr(
            'Contacts',
            '1,284 contacts · 312 active in last 30 days',
            '+ New Contact'
          )}
          ...
          {[
            ...
            <g key={ci}>
              <rect
                ...
                fill={
                  ci === 0
                    ? 'var(--illustration-info-bg)'
                    : ci % 2 === 0
                      ? W
                      : 'var(--illustration-panel)'
                }
                stroke={
                  ci === 0 ? 'var(--illustration-primary-tint-border)' : BD
                }
                strokeWidth="0.5"
              />
              ...
              {c.active && (
                <circle cx={336} cy={206 + ci * 36} r={3} fill={POS} />
              )}
            </g>
          ))}
          ...
          <rect
            ...
            height="16"
            rx="4"
            fill="var(--illustration-success-tint)"
          />
          {T(
            455,
            189,
          ...
          {[
            {
              ts: 'Today',
              act: 'Email opened — Q2 proposal',
              col: 'var(--illustration-info)',
            },
            {
              ts: 'Yesterday',
              act: 'Meeting completed · 45 min',
              col: 'var(--illustration-success)',
            },
            {
              ts: 'Apr 22',
              act: 'Call logged — 22 min',
              col: 'var(--chart-4)',
            },
            {
              ts: 'Apr 20',
            ...
            {
              ts: 'Apr 18',
              act: 'Lead converted from Webform',
              col: 'var(--chart-3)',
            },
          ].map((ev, ei) => (
            <g key={ei}>
          ...
          <rect
            ...
            rx="6"
            fill="var(--illustration-info-bg)"
            stroke="var(--illustration-primary-tint-border)"
            strokeWidth="0.5"
          />
          {T(
            388,
            440,
            '2 open opportunities · $84,000 total',
            9,
            true,
            'var(--illustration-info)'
          )}
    ...
    case 2:
      return (
        ...
        >
          ...
          {Hdr(
            'Accounts',
            '412 accounts · Group hierarchy and revenue rollup',
            '+ New Account'
          )}
          ...
          {[
            { ini: 'SC', col: 'var(--illustration-info)', n: 'Sarah Chen' },
            { ini: 'MK', col: 'var(--chart-4)', n: 'Mark Klein' },
            { ini: 'JD', col: 'var(--illustration-warning)', n: 'Jen Davis' },
          ].map((c, ci) => (
            <g key={ci}>
          ...
          {ThRow(158, 352, 428)}
          {['ACCOUNT', 'TYPE', 'REVENUE', 'DEALS', 'OWNER', 'STATUS'].map(
            (h, hidx) =>
          ...
          {[
            {
              ...
              deals: '11',
              owner: 'SC',
              oc: 'var(--illustration-info)',
              st: 'Active',
              bg: 'var(--illustration-success-tint)',
              tc: 'var(--illustration-success)',
              pw: 40,
            },
            {
              name: 'TechStart Inc',
            ...
            },
            {
              ...
              deals: '2',
              owner: 'EL',
              oc: 'var(--illustration-warning)',
              st: 'At Risk',
              bg: 'color-mix(in oklch, var(--illustration-warning) 10%, var(--background))',
              tc: 'var(--illustration-warning)',
              pw: 44,
            },
            {
              name: 'Voltline Co',
            ...
            <g key={idx}>
              <rect
                ...
                height="34"
                rx="3"
                fill={idx % 2 === 0 ? W : 'var(--illustration-panel)'}
                stroke={BD}
                strokeWidth="0.5"
              />
    ...
    case 3:
      return (
        ...
        >
          ...
          {Hdr(
            'Opportunities',
            '62 open deals · $4.8M weighted forecast · Q2 2026',
            '+ New Deal'
          )}
          ...
          {ThRow(272, 44, 736)}
          {['DEAL', 'ACCOUNT', 'STAGE', 'AMOUNT', 'PROB', 'CLOSE', 'OWNER'].map(
            (h, hidx) =>
          ...
          {(
            [
              ...
              {
                d: 'Bluepeak Migration',
                a: 'Bluepeak Ltd',
                st: 'Propose',
                stc: 'var(--illustration-warning)',
                amt: '$220K',
                p: '65%',
                cl: 'May 28',
                own: 'MS',
    ...
    case 4:
      return (
        ...
        >
          ...
          <Sb />
          {Hdr(
            'Quotation Q-2026-0184',
            'Acme Holdings · Sarah Chen · Sales Q2',
            'Send Quote'
          )}
          {/* Status strip */}
          <rect
          ...
          {[
            ...
            {
              item: 'Onboarding Package — 30 days',
              qty: '1',
              unit: '$2,400',
              tax: '$216',
              amt: '$2,616',
            ...
            {
              item: 'Training Workshop · Half-day',
              qty: '1',
              unit: '$1,200',
              tax: '$108',
              amt: '$1,308',
          ...
          <line
            ...
            strokeWidth="0.5"
          />
          {T(380, 374, 'Subtotal', 9, false, M, 'end')}
          {T(516, 374, '$12,175', 9.5, true, H, 'end')}
          {T(380, 392, 'Tax (9%)', 9, false, M, 'end')}
          {T(516, 392, '$1,145', 9.5, true, H, 'end')}
          {T(380, 410, 'Discount', 9, false, M, 'end')}
          {T(516, 410, '−$500', 9.5, true, NEG, 'end')}
          <rect
            x="316"
            y="420"
            width="208"
          ...
          <rect
            ...
            rx="5"
            fill="var(--illustration-success-tint)"
            stroke="var(--illustration-success-tint-border)"
            strokeWidth="0.5"
          />
          {T(
            666,
            442,
            '✓ Both approvers signed off',
            8.5,
            true,
            'var(--illustration-success)',
            'middle'
    ...
    case 5:
      return (
        ...
        >
          ...
          {Hdr(
            'Invoices',
            '184 invoices this quarter · Payment status & collection',
            '+ New Invoice'
          )}
          ...
          {[
            ...
            { l: '1–30', v: 0.2, c: 'var(--illustration-info)', amt: '$40K' },
            { l: '31–60', v: 0.1, c: WARN, amt: '$20K' },
            {
              l: '61–90',
              v: 0.05,
              c: 'var(--illustration-warning)',
              amt: '$10K',
            },
            ...
            let x = 52
            for (let k = 0; k < bi; k++)
              x += [0.62, 0.2, 0.1, 0.05, 0.03][k] * 720
            return (
              <g key={bi}>
                <rect
                  x={x}
          ...
          {(
            [
              ...
              },
              {
                ...
                rem: '$8,200',
                st: 'Overdue',
                bg: 'color-mix(in oklch, var(--destructive) 8%, var(--background))',
                tc: 'var(--destructive)',
                pw: 46,
              },
              {
            ...
            <g key={idx}>
              ...
              {T(48, 248 + idx * 38, r.no, 9.5, true, PRM)}
              {T(144, 248 + idx * 38, r.cust, 9)}
              {T(264, 248 + idx * 38, r.iss, 9, false, M)}
              {T(332, 248 + idx * 38, r.due, 9, false, M)}
              ...
              <rect
                ...
                height="18"
                rx="4"
                fill="var(--illustration-panel-alt)"
                stroke={BD}
                strokeWidth="0.5"
              />
              {T(
    ...
    case 6:
      return (
        ...
        >
          ...
          {Hdr(
            'Sales Orders',
            '94 open orders · Fulfilment & delivery status',
            '+ New Order'
          )}
    ...
    case 7:
      return (
        ...
        >
          ...
          {Hdr(
            'Approval Processes',
            'Configure multi-step approval chains for deals, quotes & orders',
            '+ New Process'
          )}
          ...
          {T(
            52,
            164,
            'Live · Triggered when quote amount exceeds $50,000',
            8.5,
            false,
            M
          )}
          {[
            {
              ...
              ini: 'JL',
              col: 'var(--chart-3)',
              role: 'Sales Rep · Jordan Lee',
              status: 'Submitted',
              stc: 'var(--illustration-info)',
              sbg: 'var(--illustration-info-bg)',
              time: 'Apr 26, 10:14',
              complete: true,
            },
            {
              ...
              ini: 'AB',
              col: 'var(--chart-4)',
              role: 'Sales Manager · Alex Brown',
              status: 'Approved ✓',
              stc: 'var(--illustration-success)',
              sbg: 'var(--illustration-success-tint)',
              time: 'Apr 26, 11:42',
              complete: true,
            },
            {
            ...
            },
            {
              ...
              ini: 'MR',
              col: 'var(--chart-5)',
              role: 'VP Sales · Maria Rivera',
              status: 'Pending',
              stc: 'var(--illustration-warning)',
              sbg: 'color-mix(in oklch, var(--illustration-warning) 10%, var(--background))',
              time: 'Awaiting',
              complete: false,
            },
          ].map((step, si) => (
            <g key={si}>
              {si < 3 && (
                <line
                  ...
                  x2={68}
                  y2={254 + si * 70}
                  stroke={step.complete ? POS : BD}
                  strokeWidth="2"
                  strokeDasharray={step.complete ? '0' : '3,3'}
                />
              )}
              <circle
                cx={68}
              ...
              <rect
                ...
                stroke={
                  si === 3
                    ? 'color-mix(in oklch, var(--illustration-warning) 35%, var(--border))'
                    : BD
                }
                strokeWidth="0.5"
              />
              ...
              <rect
                x={398}
                y={184 + si * 70}
                width={step.status.length * 5 + 16}
                height="16"
                rx="4"
                fill={step.sbg}
              />
              {T(
                398 + (step.status.length * 5 + 16) / 2,
                195 + si * 70,
                step.status,
                8,
                true,
          ...
          {[
            ...
            <g key={pi}>
              <rect
                ...
                fill={
                  p.urg
                    ? 'color-mix(in oklch, var(--destructive) 8%, var(--background))'
                    : 'var(--illustration-panel)'
                }
                stroke={
                  p.urg
              ...
              {T(
                ...
                7.5,
                true,
                p.urg ? 'var(--destructive)' : 'var(--muted-foreground)',
                'middle'
              )}
    ...
    case 8:
      return (
        ...
        >
          ...
          {Hdr(
            'Products & Inventory',
            '284 SKUs · Pricing, stock & catalog',
            '+ New Product'
          )}
          ...
          {/* Product table */}
          {ThRow(176)}
          {['SKU', 'PRODUCT', 'CATEGORY', 'PRICE', 'STOCK', 'STATUS'].map(
            (h, hidx) =>
          ...
          {[
            ...
            {
              sku: 'ONB-30D',
              name: 'Onboarding Package — 30 days',
              cat: 'Services',
              price: '$2,400',
              stock: '12 avail',
              st: 'Active',
            ...
            {
              sku: 'TRN-HD-01',
              name: 'Training Workshop · Half-day',
              cat: 'Training',
              price: '$1,200',
              stock: '3 left',
              st: 'Low Stock',
    ...
    case 9:
      return (
        ...
        >
          ...
          {Hdr(
            'Tickets',
            '47 open · SLA-tracked support cases',
            '+ New Ticket'
          )}
          ...
          {[
            ...
            <g key={ti}>
              <rect
                ...
                height="18"
                rx="4"
                fill={tab.a ? PRM : 'var(--illustration-panel-alt)'}
                stroke={tab.a ? PRM : BD}
                strokeWidth="0.5"
              />
              {T(
          ...
          {[
            ...
            {
              no: 'TKT-4217',
              subj: 'Quote PDF rendering issue',
              acc: 'TechStart Inc',
              pr: 'Medium',
              prc: WARN,
              sla: 0.62,
            ...
            {
              no: 'TKT-4215',
              subj: 'Add custom field — Industry',
              acc: 'Voltline Co',
              pr: 'Low',
              prc: M,
              sla: 0.84,
    ...
    case 10:
      return (
        ...
        >
          ...
          {Hdr(
            'Communications',
            'Unified inbox · Email, calls, meetings logged per record',
            '+ Compose'
          )}
          {/* Channel tabs */}
          <rect
          ...
          {[
            {
              ...
              col: 'var(--illustration-info)',
              from: 'Sarah Chen',
              subj: 'Re: Q2 Renewal Proposal',
              prev: 'Thanks for sending the updated quote. We…',
              time: '2m',
              unread: true,
              sel: true,
              type: '📧',
            },
            {
              ini: 'JL',
              col: 'var(--chart-3)',
              from: 'Call · Jordan Lee',
              subj: 'Discovery — Bluepeak Ltd',
              prev: 'Outcome: Qualified. Next step: Send proposal…',
              time: '1h',
              unread: false,
              sel: false,
              type: '📞',
            },
            {
              ...
              col: 'var(--chart-4)',
              from: 'Raj Patel',
              subj: 'Pricing question on Enterprise tier',
              prev: 'Quick question — does the Enterprise plan…',
              time: '3h',
              unread: true,
              sel: false,
              type: '📧',
            },
            {
              ini: 'MS',
              col: 'var(--illustration-success)',
              from: 'Meeting · Bluepeak demo',
              subj: 'Wed 11:00 AM — 45 min',
              prev: 'Attendees: Maya Singh, Jordan Lee. Notes:…',
              time: '5h',
              unread: false,
              sel: false,
              type: '📅',
            },
            {
              ...
              col: 'var(--illustration-warning)',
              from: 'Erik Lund',
              subj: 'Implementation timeline?',
              prev: "Hi team — we're aiming for end of Q2 go-live…",
              time: '1d',
              unread: false,
              sel: false,
              type: '📧',
            },
            {
              ...
              from: 'Anita Rao',
              subj: 'Demo follow-up',
              prev: "Following up on yesterday's demo. Sharing…",
              time: '2d',
              unread: false,
              sel: false,
              type: '📧',
            ...
            <g key={mi}>
              <rect
                ...
                height="50"
                rx="4"
                fill={m.sel ? 'var(--illustration-info-bg)' : W}
                stroke={m.sel ? 'var(--illustration-primary-tint-border)' : BD}
                strokeWidth="0.5"
              />
          ...
          {T(
            360,
            136,
            'Sarah Chen → Jordan Lee · acme.com · Apr 26',
            8.5,
            false,
            M
          )}
          ...
          {[
            {
              ...
              who: 'Sarah Chen',
              time: 'Today 10:14 AM',
              body: "Thanks for sending the updated quote. We're aligned on the pricing but need to confirm the migration timeline with our IT team.",
              outbound: false,
            },
            {
              ini: 'JL',
              ...
              who: 'Jordan Lee · You',
              time: 'Today 10:42 AM',
              body: 'Got it — happy to set up a call with our solutions architect this week. How does Thursday 2pm work?',
              outbound: true,
            },
            {
              ini: 'SC',
              ...
              who: 'Sarah Chen',
              time: 'Today 11:01 AM',
              body: "Thursday 2pm works on our side. I'll loop in Mark from IT.",
              outbound: false,
            },
          ].map((msg, mi) => (
            <g key={mi}>
              <rect
                x={msg.outbound ? 432 : 372}
                y={180 + mi * 70}
                width="340"
                height="62"
                rx="6"
                ...
                stroke={
                  msg.outbound ? 'var(--illustration-primary-tint-border)' : BD
                }
                strokeWidth="0.5"
              />
              {Avatar(
                msg.outbound ? 752 : 386,
                192 + mi * 70,
                msg.ini,
                msg.col,
                6
              ...
              {T(
                msg.outbound ? 740 : 398,
                195 + mi * 70,
                msg.who,
                8.5,
                true,
                H,
                msg.outbound ? 'end' : 'start'
              )}
              {T(
                msg.outbound ? 740 : 398,
                205 + mi * 70,
              ...
              {T(
                msg.outbound ? 762 : 384,
                222 + mi * 70,
                msg.body.substring(0, 60),
                8,
                false,
                msg.outbound ? 'var(--illustration-info)' : H,
                msg.outbound ? 'end' : 'start'
              )}
              {T(
                msg.outbound ? 762 : 384,
                234 + mi * 70,
                msg.body.substring(60, 120),
                8,
                false,
                msg.outbound ? 'var(--illustration-info)' : H,
                msg.outbound ? 'end' : 'start'
    ...
    case 11:
      return (
        ...
        >
          ...
          {Hdr(
            'Marketing Campaigns',
            '18 active · Lead attribution and revenue impact',
            '+ New Campaign'
          )}
          ...
          {[
            {
              l: 'Webform',
              n: '180 leads · 42%',
              c: 'var(--illustration-info)',
            },
            { l: 'Email cadences', n: '104 leads · 24%', c: 'var(--chart-4)' },
            {
              l: 'Events',
              n: '76 leads · 18%',
              c: 'var(--illustration-success)',
            },
            {
              l: 'LinkedIn ads',
              n: '68 leads · 16%',
          ...
          {[
            ...
            { l: 'Closed-won', v: 38, w: 0.1, c: 'var(--chart-3)' },
          ].map((f, fi) => {
            const fullW = 360
            const w = fullW * f.w
          ...
          {(
            ...
            <g key={idx}>
              ...
              {T(56, 410 + idx * 22, r.c, 9, true, PRM)}
              {T(248, 410 + idx * 22, r.ch, 9, false, M)}
    ...
    case 12:
      return (
        ...
        >
          ...
          {Hdr(
            'Webform Builder',
            'Demo Request — embedded on pricing.zopkit.com',
            'Publish'
          )}
          {/* Tabs */}
          <rect
          ...
          {T(
            412,
            175,
            'Get a tailored walkthrough in 30 minutes',
            9,
            false,
            M,
            'middle'
          ...
          {[
            ...
            <g key={fi}>
              ...
              <rect
                ...
                rx="4"
                fill={W}
                stroke={fi === 1 ? 'var(--illustration-info)' : BD}
                strokeWidth={fi === 1 ? '1' : '0.5'}
              />
    ...
    case 13:
      return (
        ...
        >
          ...
          <Sb />
          {Hdr(
            'Cadence · Outbound — Mid-Market',
            '5 steps · 412 contacts enrolled · 38% reply rate',
            'Enroll Contacts'
          )}
          ...
          {[
            {
              day: 'Day 0',
              type: 'Email',
              subj: 'Quick intro · Sales acceleration',
              body: 'Hi {{first_name}}, noticed Acme is hiring SDRs…',
              open: 78,
              reply: 22,
              sent: 412,
              col: 'var(--illustration-info)',
            ...
            },
            {
              day: 'Day 4',
              type: 'Task',
              subj: 'Call · 5-minute pitch',
              body: 'Manual task — call mobile or office line',
              open: 0,
              reply: 0,
              sent: 220,
              col: 'var(--illustration-success)',
            ...
            },
            {
              day: 'Day 7',
              type: 'LinkedIn',
              subj: 'Connection request + note',
              body: 'Personalized note based on profile',
              open: 0,
              reply: 0,
              sent: 184,
              col: 'var(--chart-4)',
            ...
            },
            {
              day: 'Day 12',
              type: 'Email',
              subj: 'Last note — closing your file',
              body: 'Wanted to make one final attempt before…',
              open: 58,
              reply: 18,
              sent: 142,
              col: 'var(--illustration-warning)',
            ...
            <g key={si}>
              ...
              {T(
                132,
                204 + si * 56,
                s.body.length > 70 ? s.body.substring(0, 70) + '…' : s.body,
                8.5,
                false,
                M
              )}
              ...
              {s.open > 0 && (
                <>
                  {T(688, 184 + si * 56, 'Open %', 7, true, M)}
                  {T(688, 200 + si * 56, s.open + '%', 12, true, POS)}
                </>
              )}
              {s.reply > 0 && (
                <>
                  {T(740, 184 + si * 56, 'Reply %', 7, true, M)}
                  {T(
                    740,
                    200 + si * 56,
                    s.reply + '%',
    ...
    case 14:
      return (
        ...
        >
          ...
          <Sb />
          {Hdr(
            'Bulk Upload · contacts_april.csv',
            'Step 2 of 4 · Map columns to CRM fields',
            'Run Import'
          )}
          {/* Wizard steps */}
          <rect
          ...
          {[
            ...
            <g key={si}>
              <circle
                ...
                cy={70}
                r={11}
                fill={s.active ? PRM : s.done ? POS : W}
                stroke={s.active || s.done ? 'transparent' : BD}
                strokeWidth="1.5"
              />
              <text
                x={92 + si * 188}
          ...
          {T(
            84,
            138,
            '1,284 rows · 12 columns · UTF-8 encoded',
            8.5,
            false,
            'var(--illustration-info)'
          )}
          ...
          <rect
            ...
            height="14"
            rx="3"
            fill="color-mix(in oklch, var(--illustration-warning) 10%, var(--background))"
          />
          {T(
            746,
            120,
          ...
          {T(
            776,
            138,
            'Last imported: 14 days ago · 1,012 records',
            8,
            false,
            'var(--illustration-info)',
            'end'
          ...
          {[
            ...
            },
            {
              col: 'industry',
              samp: 'SaaS',
              map: 'Account · Industry',
              ok: true,
            },
            {
              col: 'lead_owner_email',
              samp: 'jordan@zopkit.com',
              map: 'Owner (lookup)',
              ok: true,
            },
            {
            ...
            <g key={idx}>
              ...
              <rect
                ...
                height="14"
                rx="3"
                fill={r.ok ? W : 'var(--illustration-panel-alt)'}
                stroke={r.ok ? 'var(--illustration-primary-tint-border)' : BD}
                strokeWidth="0.5"
              />
              {T(
                496,
    ...
    case 15:
      return (
        ...
        >
          ...
          <Sb />
          {Hdr(
            'Calendar · Week of Apr 26',
            '12 events · 4 meetings · 3 deal milestones',
            '+ New Event'
          )}
          {/* View toggle */}
          <rect
          ...
          {[
            ...
            <g key={di}>
              <rect
                ...
                height="28"
                rx="0"
                fill={di === 2 ? 'var(--illustration-info-bg)' : W}
                stroke={BD}
                strokeWidth="0.5"
              />
              {T(
                ...
                8.5,
                di === 2,
                di === 2 ? 'var(--illustration-info)' : M,
                'middle'
              )}
            </g>
          ))}
          {/* Time column */}
          {['9 AM', '10', '11', '12 PM', '1', '2', '3', '4', '5'].map(
            (t, ti) => (
              <g key={ti}>
                <rect
                  x="36"
          ...
          {[
            ...
            },
            {
              ...
              name: 'Cadence review',
              col: 'var(--chart-3)',
              bg: 'color-mix(in oklch, var(--chart-3) 10%, var(--background))',
            },
            {
              d: 3,
              t: 6,
              ...
              name: '1:1 · Manager',
              col: 'var(--chart-5)',
              bg: 'color-mix(in oklch, var(--chart-5) 8%, var(--background))',
            },
            {
              d: 4,
              t: 1,
          ...
          {[
            {
              ...
              name: 'Call Sarah Chen — confirm migration timeline',
              rec: 'Deal · Acme Q2 Renewal',
              due: 'Today 11:00',
              dueC: WARN,
              pr: 'High',
              prc: NEG,
              icon: '📞',
              iconC: 'var(--illustration-success)',
              own: 'JL',
              oc: 'var(--chart-3)',
            },
            {
              done: false,
              name: 'Send proposal — Bluepeak migration',
              rec: 'Deal · Bluepeak',
              due: 'Today 2:00 PM',
              dueC: WARN,
              pr: 'High',
              prc: NEG,
              icon: '📧',
              iconC: 'var(--illustration-info)',
              own: 'JL',
              oc: 'var(--chart-3)',
            },
            {
              done: false,
              name: 'Follow up on quote Q-2026-0181',
              rec: 'Quote · Nordic AB',
              due: 'Today 4:30 PM',
              dueC: WARN,
              pr: 'Med',
            ...
            },
            {
              ...
              name: 'Demo prep — Voltline deep dive',
              rec: 'Account · Voltline',
              due: 'Tomorrow',
              dueC: M,
              pr: 'Med',
              prc: WARN,
            ...
            },
            {
              ...
              name: 'Renewal reminder — TechStart Inc',
              rec: 'Account · TechStart',
              due: 'Apr 28',
              dueC: M,
              pr: 'Med',
              prc: WARN,
            ...
            },
            {
              ...
              name: 'Onboarding kickoff — Mosaic Group',
              rec: 'Account · Mosaic',
              due: 'Done · Apr 25',
              dueC: POS,
              pr: 'Low',
            ...
            },
            {
              ...
              name: 'Quarterly business review — Acme',
              rec: 'Account · Acme',
              due: 'Done · Apr 24',
              dueC: POS,
              pr: 'High',
            ...
            <g key={ti}>
              <rect
                ...
                height="34"
                rx="5"
                fill={ti % 2 === 0 ? W : 'var(--illustration-panel)'}
                stroke={BD}
                strokeWidth="0.5"
              />
              <rect
    ...
    case 17:
      return (
        ...
        >
          ...
          <Sb />
          {Hdr(
            'Deal Notes · Acme Q2 Renewal',
            '5 notes · 3 documents · Linked to opportunity DEAL-0042',
            '+ New Note'
          )}
          {/* Notes list */}
          <rect
          ...
          {[
            ...
            {
              type: 'Note',
              title: 'Pricing objection — counter $48K',
              who: 'JL',
              col: 'var(--chart-3)',
              time: '2d ago',
              sel: false,
            ...
            {
              type: 'Doc',
              title: 'Security_questionnaire.xlsx',
              who: 'Sec',
              col: 'var(--illustration-success)',
              time: '1w ago',
              sel: false,
            ...
            {
              type: 'Note',
              title: 'Competitor mentions — Salesforce',
              who: 'MR',
              col: 'var(--illustration-warning)',
              time: '1w ago',
              sel: false,
            ...
            <g key={ni}>
              <rect
                ...
                height="44"
                rx="5"
                fill={n.sel ? 'var(--illustration-info-bg)' : W}
                stroke={n.sel ? 'var(--illustration-primary-tint-border)' : BD}
                strokeWidth="0.5"
              />
              <rect
                x="52"
          ...
          <rect
            ...
            height="20"
            rx="4"
            fill="color-mix(in oklch, var(--chart-4) 8%, var(--background))"
          />
          ...
          <rect
            ...
            height="22"
            rx="3"
            fill="color-mix(in oklch, var(--destructive) 12%, var(--background))"
          />
    ...
    case 18:
      return (
        ...
        >
          ...
          <Sb />
          {Hdr(
            'Layout Editor · Contact',
            'Drag fields to rearrange · 18 custom fields configured',
            'Save Layout'
          )}
          {/* Field palette */}
          <rect
            ...
            <g key={fi}>
              <rect
                ...
                stroke={
                    ...
                    ? 'color-mix(in oklch, var(--chart-4) 35%, var(--border))'
                    : BD
                }
                strokeWidth={fi === 0 ? '1' : '0.5'}
              />
              {T(f.x + 8, f.y + 12, f.l, 7.5, true, M)}
              {T(f.x + 8, f.y + 26, f.v, 9, false, H)}
              {fi === 0 && (
    ...
    case 19:
      return (
        ...
        >
          ...
          <Sb />
          {Hdr(
            'Function · Sync Deal to External CRM',
            'JavaScript · Triggered by button on Opportunity record',
            'Save & Deploy'
          )}
          ...
          {[
            {
              l: '[10:42:18] Function syncDealToHubspot()',
              c: 'var(--chart-3)',
            },
            { l: '[10:42:18] Fetched record DEAL-0042', c: 'var(--chart-3)' },
            {
              l: '[10:42:19] POST → api.hubapi.com/deals',
              c: 'var(--illustration-info)',
            },
            {
              l: '[10:42:19] ↳ Status 200 · 248ms',
              c: 'var(--illustration-success)',
            },
            {
              l: '[10:42:19] Deal synced · ID 8421-XYZ',
              c: 'var(--illustration-success)',
            },
            {
              l: '[10:42:19] ✓ Function completed (1.2s)',
              c: 'var(--illustration-success)',
            },
          ...
          {[
            {
              ...
              c: 'async function ',
              cc: 'var(--chart-4)',
              c2: 'syncDealToHubspot',
              cc2: 'var(--illustration-info)',
              c3: '({ record, client }) {',
              cc3: 'var(--border)',
            },
            {
            ...
            {
              ln: 4,
              c: '  // Map CRM fields to HubSpot schema',
              cc: 'var(--muted-foreground)',
              c2: '',
              cc2: '',
              c3: '',
              cc3: '',
            ...
            {
              ln: 8,
              c: '    closedate: deal.expectedCloseDate,',
              cc: 'var(--border)',
              c2: '',
              cc2: '',
              c3: '',
            ...
            {
              ln: 12,
              c: '  // POST to HubSpot v3 deals API',
              cc: 'var(--muted-foreground)',
              c2: '',
              cc2: '',
              c3: '',
            ...
            },
            {
              ...
              c: '    ',
              cc: 'var(--border)',
              c2: '"https://api.hubapi.com/v3/objects/deals"',
              cc2: 'var(--illustration-success-tint-border)',
              c3: ',',
              cc3: 'var(--border)',
            },
            {
            ...
            {
              ln: 17,
              c: '  return { id: res.id, synced: ',
              cc: 'var(--border)',
              c2: 'true',
              cc2: 'var(--illustration-warning)',
              c3: ' };',
              cc3: 'var(--border)',
            },
            {
            ...
            <g key={ri}>
              ...
              {row.c3 && (
                <text
                  x={408 + (row.c.length + row.c2.length) * 4.6}
                  y={102 + ri * 18}
                  fontFamily="ui-monospace,monospace"
                  fontSize="8.5"
                  fill={row.cc3}
          ...
          {T(
            388,
            448,
            '✓ Saved · Deployed · 1.2s avg runtime · 142 executions today',
            8.5,
            true,
            'var(--illustration-success)'
          )}
    ...
    case 20:
      return (
        ...
        >
          ...
          {Hdr(
            'Outbound Webhooks',
            '8 active · Push CRM events to external systems in real time',
            '+ New Webhook'
          )}
          ...
          {[
            ...
            {
              name: 'Internal API — Billing',
              url: 'api.acme.com/crm-events',
          ...
          {[
            ...
            <g key={di}>
              <rect
                ...
                height="26"
                rx="3"
                fill={di % 2 === 0 ? W : 'var(--illustration-panel)'}
                stroke={BD}
                strokeWidth="0.3"
              />
              ...
              {T(
                ...
                8,
                true,
                d.ok ? 'var(--illustration-success)' : 'var(--destructive)',
                'middle'
              )}
            </g>
          ))}
