    ...
    switch (i) {
        ...
        case 0: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                {/* Kanban columns */}
                {([
                    { name: "New", count: "15", color: "var(--illustration-info)", bg: "var(--illustration-info-bg)" },
                    { name: "Contacted", count: "12", color: "var(--chart-4)", bg: "color-mix(in oklch, var(--chart-4) 8%, var(--background))" },
                    { name: "Qualified", count: "10", color: "var(--illustration-warning)", bg: "color-mix(in oklch, var(--illustration-warning) 10%, var(--background))" },
                    { name: "Proposal", count: "10", color: "var(--illustration-success)", bg: "var(--illustration-success-tint)" },
                ] as const).map((col, ci) => (
                    <g key={ci}>
                        <rect x={36 + ci * 190} y="130" width="180" height="334" rx="8" fill="var(--illustration-panel)" stroke={BD} strokeWidth="1" />
                ...
                {/* Lead cards */}
                {([
                    { col: 0, top: 172, name: "Acme Corp", contact: "Sarah Chen", score: 85, src: "Webform", ini: "SC", col2: "var(--illustration-info)" },
                    { col: 0, top: 244, name: "TechStart Inc", contact: "Raj Patel", score: 68, src: "Cold email", ini: "RP", col2: "var(--chart-4)" },
                    { col: 0, top: 316, name: "Bluepeak Ltd", contact: "Maya Singh", score: 91, src: "Referral", ini: "MS", col2: "var(--illustration-success)" },
                    { col: 1, top: 172, name: "Nordic AB", contact: "Erik Lund", score: 76, src: "LinkedIn", ini: "EL", col2: "var(--illustration-warning)" },
                    { col: 1, top: 244, name: "Voltline Co", contact: "Anita Rao", score: 64, src: "Webform", ini: "AR", col2: "var(--chart-5)" },
                    { col: 2, top: 172, name: "Pacific Logix", contact: "Jordan Lee", score: 88, src: "Event", ini: "JL", col2: "var(--chart-3)" },
                    { col: 2, top: 244, name: "Helix Software", contact: "Priya Iyer", score: 79, src: "Webform", ini: "PI", col2: "var(--chart-4)" },
                    { col: 3, top: 172, name: "Mosaic Group", contact: "Tom Williams", score: 94, src: "Referral", ini: "TW", col2: "var(--illustration-success)" },
                    { col: 3, top: 244, name: "Indus Foods", contact: "Aisha Khan", score: 81, src: "Webform", ini: "AK", col2: "var(--illustration-warning)" },
                ]).map((c, ci) => (
                    <g key={ci}>
                        ...
                        <rect x={172 + c.col * 190} y={c.top + 44} width="28" height="14" rx="3" fill={c.score >= 80 ? "var(--illustration-success-tint)" : c.score >= 70 ? "color-mix(in oklch, var(--illustration-warning) 10%, var(--background))" : "var(--illustration-panel-alt)"} />
                        {T(186 + c.col * 190, c.top + 54, String(c.score), 8, true, c.score >= 80 ? "var(--illustration-success)" : c.score >= 70 ? "var(--illustration-warning)" : "var(--muted-foreground)", "middle")}
                    </g>
                ))}
            </svg>
        );
        ...
        case 1: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                <rect x="44" y="160" width="304" height="22" rx="4" fill="var(--illustration-panel)" stroke={BD} strokeWidth="0.5" />
                <rect x="50" y="166" width="60" height="10" rx="3" fill={W} stroke={BD} strokeWidth="0.5" />
                {T(80, 174, "Search", 8, false, M, "middle")}
                {([
                    { ini: "SC", col: "var(--illustration-info)", name: "Sarah Chen", co: "Acme Corp", role: "VP Sales", active: true },
                    { ini: "RP", col: "var(--chart-4)", name: "Raj Patel", co: "TechStart Inc", role: "CTO", active: true },
                    { ini: "MS", col: "var(--illustration-success)", name: "Maya Singh", co: "Bluepeak", role: "Head of Ops", active: true },
                    { ini: "EL", col: "var(--illustration-warning)", name: "Erik Lund", co: "Nordic AB", role: "Director", active: false },
                    { ini: "AR", col: "var(--chart-5)", name: "Anita Rao", co: "Voltline Co", role: "Manager", active: true },
                    { ini: "JL", col: "var(--chart-3)", name: "Jordan Lee", co: "Pacific Logix", role: "Co-founder", active: true },
                    { ini: "PI", col: "var(--illustration-warning)", name: "Priya Iyer", co: "Helix Software", role: "VP Product", active: false },
                ]).map((c, ci) => (
                    <g key={ci}>
                        <rect x="44" y={190 + ci * 36} width="304" height="32" rx="4" fill={ci === 0 ? "var(--illustration-info-bg)" : (ci % 2 === 0 ? W : "var(--illustration-panel)")} stroke={ci === 0 ? "var(--illustration-primary-tint-border)" : BD} strokeWidth="0.5" />
                ...
                {Avatar(400, 158, "SC", "var(--illustration-info)", 16)}
                {T(424, 156, "Sarah Chen", 13, true, H)}
                {T(424, 170, "VP Sales · Acme Corp · acme.com", 8.5, false, M)}
                <rect x="424" y="178" width="62" height="16" rx="4" fill="var(--illustration-success-tint)" />
                {T(455, 189, "Decision Maker", 7.5, true, "var(--illustration-success)", "middle")}
                <rect x="492" y="178" width="46" height="16" rx="4" fill="var(--illustration-info-bg)" />
                {T(515, 189, "Champion", 7.5, true, "var(--illustration-info)", "middle")}
                {/* Activity timeline */}
                {T(384, 220, "Activity Timeline", 10, true, H)}
                {([
                    { ts: "Today", act: "Email opened — Q2 proposal", col: "var(--illustration-info)" },
                    { ts: "Yesterday", act: "Meeting completed · 45 min", col: "var(--illustration-success)" },
                    { ts: "Apr 22", act: "Call logged — 22 min", col: "var(--chart-4)" },
                    { ts: "Apr 20", act: "Quote sent — $48K", col: "var(--illustration-warning)" },
                    { ts: "Apr 18", act: "Lead converted from Webform", col: "var(--chart-3)" },
                ]).map((ev, ei) => (
                    <g key={ei}>
                        ...
                        <rect x={412} y={232 + ei * 36} width="362" height="26" rx="4" fill="var(--illustration-panel)" stroke={BD} strokeWidth="0.5" />
                        {T(420, 244 + ei * 36, ev.ts, 8, true, M)}
                        {T(420, 254 + ei * 36, ev.act, 9, false, H)}
                    </g>
                ))}
                <rect x="376" y="420" width="400" height="32" rx="6" fill="var(--illustration-info-bg)" stroke="var(--illustration-primary-tint-border)" strokeWidth="0.5" />
                {T(388, 440, "2 open opportunities · $84,000 total", 9, true, "var(--illustration-info)")}
            </svg>
        );
        ...
        case 2: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                <rect x="44" y="290" width="280" height="22" rx="4" fill="var(--illustration-info-bg)" />
                {T(52, 304, "Group revenue: $4.2M YTD", 8.5, true, "var(--illustration-info)")}
                <rect x="44" y="318" width="280" height="22" rx="4" fill="var(--illustration-panel)" />
                {T(52, 332, "Open opportunities: 11 · $1.8M", 8.5, false, M)}
                <rect x="44" y="346" width="280" height="22" rx="4" fill="var(--illustration-success-tint)" />
                {T(52, 360, "Health score: Excellent ✓", 8.5, true, "var(--illustration-success)")}
                <rect x="44" y="378" width="280" height="74" rx="6" fill="var(--illustration-panel)" stroke={BD} strokeWidth="0.5" />
                {T(56, 395, "TOP CONTACTS (3)", 7.5, true, M)}
                {[{ ini: "SC", col: "var(--illustration-info)", n: "Sarah Chen" }, { ini: "MK", col: "var(--chart-4)", n: "Mark Klein" }, { ini: "JD", col: "var(--illustration-warning)", n: "Jen Davis" }].map((c, ci) => (
                    <g key={ci}>
                ...
                {([
                    { name: "Acme Holdings", type: "Parent", rev: "$4.2M", deals: "11", owner: "SC", oc: "var(--illustration-info)", st: "Active", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 40 },
                    { name: "TechStart Inc", type: "Enterprise", rev: "$1.8M", deals: "5", owner: "RP", oc: "var(--chart-4)", st: "Active", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 40 },
                    { name: "Bluepeak Ltd", type: "Mid-Market", rev: "$680K", deals: "3", owner: "MS", oc: "var(--illustration-success)", st: "Active", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 40 },
                    { name: "Nordic AB", type: "Mid-Market", rev: "$520K", deals: "2", owner: "EL", oc: "var(--illustration-warning)", st: "At Risk", bg: "color-mix(in oklch, var(--illustration-warning) 10%, var(--background))", tc: "var(--illustration-warning)", pw: 44 },
                    { name: "Voltline Co", type: "SMB", rev: "$240K", deals: "4", owner: "AR", oc: "var(--chart-5)", st: "Active", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 40 },
                    { name: "Helix Software", type: "Mid-Market", rev: "$420K", deals: "2", owner: "PI", oc: "var(--illustration-warning)", st: "Active", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 40 },
                    { name: "Mosaic Group", type: "Enterprise", rev: "$1.1M", deals: "6", owner: "TW", oc: "var(--chart-3)", st: "Active", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 40 },
                ]).map((r, idx) => (
                    <g key={idx}>
                        <rect x="352" y={182 + idx * 38} width="428" height="34" rx="3" fill={idx % 2 === 0 ? W : "var(--illustration-panel)"} stroke={BD} strokeWidth="0.5" />
        ...
        case 3: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                {([
                    { stage: "Discover", n: "22", amt: "$1.8M", w: 0.20, col: "var(--illustration-info)" },
                    { stage: "Qualify", n: "18", amt: "$2.1M", w: 0.40, col: "var(--chart-4)" },
                    { stage: "Propose", n: "12", amt: "$2.4M", w: 0.65, col: "var(--illustration-warning)" },
                    { stage: "Negotiate", n: "7", amt: "$1.4M", w: 0.85, col: "var(--chart-3)" },
                    { stage: "Closing", n: "3", amt: "$0.5M", w: 0.95, col: "var(--illustration-success)" },
                ]).map((s, si) => (
                    <g key={si}>
                ...
                {([
                    { d: "Acme Q2 Renewal", a: "Acme Holdings", st: "Negotiate", stc: "var(--chart-3)", amt: "$340K", p: "85%", cl: "May 15", own: "SC", oc: "var(--illustration-info)" },
                    { d: "Bluepeak Migration", a: "Bluepeak Ltd", st: "Propose", stc: "var(--illustration-warning)", amt: "$220K", p: "65%", cl: "May 28", own: "MS", oc: "var(--illustration-success)" },
                    { d: "Nordic Platform Deal", a: "Nordic AB", st: "Qualify", stc: "var(--chart-4)", amt: "$180K", p: "40%", cl: "Jun 10", own: "EL", oc: "var(--illustration-warning)" },
                    { d: "Mosaic Enterprise", a: "Mosaic Group", st: "Closing", stc: "var(--illustration-success)", amt: "$420K", p: "95%", cl: "May 8", own: "TW", oc: "var(--chart-3)" },
                    { d: "Pacific Logix Expand", a: "Pacific Logix", st: "Propose", stc: "var(--illustration-warning)", amt: "$155K", p: "65%", cl: "May 22", own: "JL", oc: "var(--chart-3)" },
                ] as const).map((r, idx) => (
                    <g key={idx}>
        ...
        case 4: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                {/* Status strip */}
                <rect x="36" y="52" width="752" height="40" rx="6" fill="var(--illustration-panel)" stroke={BD} strokeWidth="1" />
                {([
                ...
                {/* Document header */}
                <rect x="36" y="106" width="492" height="62" rx="6" fill="var(--illustration-panel)" />
                <rect x="36" y="158" width="492" height="10" fill="var(--illustration-panel)" />
                ...
                <rect x="316" y="420" width="208" height="32" rx="5" fill="var(--illustration-info-bg)" />
                {T(330, 440, "TOTAL", 11, true, "var(--illustration-info)")}
                {T(516, 440, "$12,820", 14, true, "var(--illustration-info)", "end")}
                {/* Side panel */}
                ...
                <rect x="556" y="422" width="220" height="32" rx="5" fill="var(--illustration-success-tint)" stroke="var(--illustration-success-tint-border)" strokeWidth="0.5" />
                {T(666, 442, "✓ Both approvers signed off", 8.5, true, "var(--illustration-success)", "middle")}
            </svg>
        );
        ...
        case 5: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                {([
                    ...
                    { l: "1–30", v: 0.20, c: "var(--illustration-info)", amt: "$40K" },
                    { l: "31–60", v: 0.10, c: WARN, amt: "$20K" },
                    { l: "61–90", v: 0.05, c: "var(--illustration-warning)", amt: "$10K" },
                ...
                {([
                    { no: "INV-1842", cust: "Acme Holdings", iss: "Apr 22", due: "May 22", amt: "$12,820", rem: "$12,820", st: "Sent", bg: "var(--illustration-info-bg)", tc: "var(--illustration-info)", pw: 32 },
                    { no: "INV-1841", cust: "Bluepeak Ltd", iss: "Apr 18", due: "May 18", amt: "$6,400", rem: "$3,200", st: "Partial", bg: "color-mix(in oklch, var(--illustration-warning) 10%, var(--background))", tc: "var(--illustration-warning)", pw: 40 },
                    { no: "INV-1840", cust: "Mosaic Group", iss: "Apr 12", due: "May 12", amt: "$28,500", rem: "$0", st: "Paid", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 32 },
                    { no: "INV-1839", cust: "Nordic AB", iss: "Mar 30", due: "Apr 29", amt: "$8,200", rem: "$8,200", st: "Overdue", bg: "color-mix(in oklch, var(--destructive) 8%, var(--background))", tc: "var(--destructive)", pw: 46 },
                    { no: "INV-1838", cust: "Voltline Co", iss: "Mar 28", due: "Apr 27", amt: "$3,600", rem: "$0", st: "Paid", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 32 },
                    { no: "INV-1837", cust: "Pacific Logix", iss: "Mar 22", due: "Apr 21", amt: "$14,200", rem: "$0", st: "Paid", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 32 },
                ] as const).map((r, idx) => (
                    <g key={idx}>
                        ...
                        <rect x={660} y={238 + idx * 38} width="100" height="18" rx="4" fill="var(--illustration-panel-alt)" stroke={BD} strokeWidth="0.5" />
        ...
        case 6: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                <rect x="36" y="130" width="752" height="60" rx="6" fill="var(--illustration-panel)" stroke={BD} strokeWidth="1" />
                ...
                {([
                    { no: "SO-3142", acc: "Acme Holdings", items: "12", val: "$48,200", stage: "Shipped", stc: "var(--chart-3)", date: "May 2", st: "On Track", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 48 },
                    { no: "SO-3141", acc: "TechStart Inc", items: "4", val: "$12,800", stage: "Picked", stc: "var(--illustration-warning)", date: "May 3", st: "On Track", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 48 },
                    { no: "SO-3140", acc: "Bluepeak Ltd", items: "8", val: "$24,400", stage: "Confirmed", stc: "var(--chart-4)", date: "May 6", st: "On Track", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 48 },
                    { no: "SO-3139", acc: "Mosaic Group", items: "22", val: "$84,500", stage: "Shipped", stc: "var(--chart-3)", date: "May 2", st: "Priority", bg: "color-mix(in oklch, var(--destructive) 8%, var(--background))", tc: "var(--destructive)", pw: 44 },
                    { no: "SO-3138", acc: "Voltline Co", items: "3", val: "$6,800", stage: "Delivered", stc: "var(--illustration-success)", date: "Apr 28", st: "Closed", bg: "var(--illustration-panel-alt)", tc: "var(--muted-foreground)", pw: 40 },
                    { no: "SO-3137", acc: "Helix Software", items: "6", val: "$18,200", stage: "Picked", stc: "var(--illustration-warning)", date: "May 4", st: "On Track", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 48 },
                ] as const).map((r, idx) => (
                    <g key={idx}>
                        {Tr(226 + idx * 38, idx % 2 === 0)}
        ...
        case 7: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                {([
                    { l: "Submitter", ini: "JL", col: "var(--chart-3)", role: "Sales Rep · Jordan Lee", status: "Submitted", stc: "var(--illustration-info)", sbg: "var(--illustration-info-bg)", time: "Apr 26, 10:14", complete: true },
                    { l: "Step 1", ini: "AB", col: "var(--chart-4)", role: "Sales Manager · Alex Brown", status: "Approved ✓", stc: "var(--illustration-success)", sbg: "var(--illustration-success-tint)", time: "Apr 26, 11:42", complete: true },
                    { l: "Step 2", ini: "DK", col: "var(--illustration-warning)", role: "Finance · Dan Klein", status: "Approved ✓", stc: "var(--illustration-success)", sbg: "var(--illustration-success-tint)", time: "Apr 26, 14:21", complete: true },
                    { l: "Step 3", ini: "MR", col: "var(--chart-5)", role: "VP Sales · Maria Rivera", status: "Pending", stc: "var(--illustration-warning)", sbg: "color-mix(in oklch, var(--illustration-warning) 10%, var(--background))", time: "Awaiting", complete: false },
                ]).map((step, si) => (
                    <g key={si}>
                        ...
                        <rect x={96} y={176 + si * 70} width="424" height="48" rx="5" fill={si === 3 ? "color-mix(in oklch, var(--illustration-warning) 10%, var(--background))" : "var(--illustration-panel)"} stroke={si === 3 ? "color-mix(in oklch, var(--illustration-warning) 35%, var(--border))" : BD} strokeWidth="0.5" />
                ...
                {([
                    ...
                    <g key={pi}>
                        <rect x="556" y={168 + pi * 56} width="224" height="48" rx="5" fill={p.urg ? "color-mix(in oklch, var(--destructive) 8%, var(--background))" : "var(--illustration-panel)"} stroke={p.urg ? "color-mix(in oklch, var(--destructive) 25%, var(--border))" : BD} strokeWidth="0.5" />
                        {T(566, 184 + pi * 56, p.rec, 9, true, PRM)}
                        <rect x={730} y={172 + pi * 56} width="42" height="14" rx="3" fill={p.urg ? "color-mix(in oklch, var(--destructive) 25%, var(--border))" : BD} opacity="0.7" />
                        {T(751, 182 + pi * 56, p.age + " ago", 7.5, true, p.urg ? "var(--destructive)" : "var(--muted-foreground)", "middle")}
        ...
        case 8: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                {/* Category chips */}
                <rect x="36" y="130" width="752" height="32" rx="6" fill="var(--illustration-panel)" stroke={BD} strokeWidth="1" />
                ...
                {([
                    { sku: "CRM-ENT-01", name: "Zopkit CRM — Enterprise", cat: "Software", price: "$199 /seat", stock: "∞", st: "Active", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 40, sc: H },
                    { sku: "CRM-PRO-01", name: "Zopkit CRM — Professional", cat: "Software", price: "$99 /seat", stock: "∞", st: "Active", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 40, sc: H },
                    { sku: "ONB-30D", name: "Onboarding Package — 30 days", cat: "Services", price: "$2,400", stock: "12 avail", st: "Active", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 40, sc: H },
                    { sku: "INT-API-01", name: "Custom Integration — API", cat: "Services", price: "$1,800", stock: "8 avail", st: "Active", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 40, sc: H },
                    { sku: "TRN-HD-01", name: "Training Workshop · Half-day", cat: "Training", price: "$1,200", stock: "3 left", st: "Low Stock", bg: "color-mix(in oklch, var(--illustration-warning) 10%, var(--background))", tc: "var(--illustration-warning)", pw: 60, sc: WARN },
                    { sku: "HW-DOCK-04", name: "Sales Dock — USB-C Hub", cat: "Hardware", price: "$320", stock: "0", st: "Out", bg: "color-mix(in oklch, var(--destructive) 8%, var(--background))", tc: "var(--destructive)", pw: 28, sc: NEG },
                ]).map((r, idx) => (
                    <g key={idx}>
                        ...
                        <rect x="124" y={212 + idx * 42} width="14" height="14" rx="2" fill="var(--illustration-panel-alt)" />
        ...
        case 9: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                {([{ l: "All", n: "47", a: true }, { l: "Open", n: "31" }, { l: "Pending", n: "9" }, { l: "Resolved", n: "478" }, { l: "Closed", n: "1,284" }]).map((tab, ti) => (
                    <g key={ti}>
                        <rect x={48 + ti * 142} y="138" width="132" height="18" rx="4" fill={tab.a ? PRM : "var(--illustration-panel-alt)"} stroke={tab.a ? PRM : BD} strokeWidth="0.5" />
                ...
                {([
                    { no: "TKT-4218", subj: "Cannot sync inbox — Gmail", acc: "Acme Holdings", pr: "High", prc: NEG, sla: 0.18, slaT: "2h 12m", st: "Open", bg: "var(--illustration-info-bg)", tc: "var(--illustration-info)", pw: 32, own: "DS", oc: "var(--illustration-info)" },
                    { no: "TKT-4217", subj: "Quote PDF rendering issue", acc: "TechStart Inc", pr: "Medium", prc: WARN, sla: 0.62, slaT: "6h left", st: "In Prog.", bg: "color-mix(in oklch, var(--illustration-warning) 10%, var(--background))", tc: "var(--illustration-warning)", pw: 48, own: "MA", oc: "var(--illustration-success)" },
                    { no: "TKT-4216", subj: "Webhook delivery failing", acc: "Bluepeak Ltd", pr: "High", prc: NEG, sla: 0.08, slaT: "32m left", st: "Open", bg: "var(--illustration-info-bg)", tc: "var(--illustration-info)", pw: 32, own: "DS", oc: "var(--illustration-info)" },
                    { no: "TKT-4215", subj: "Add custom field — Industry", acc: "Voltline Co", pr: "Low", prc: M, sla: 0.84, slaT: "2d left", st: "Pending", bg: "var(--illustration-panel-alt)", tc: "var(--muted-foreground)", pw: 48, own: "PJ", oc: "var(--chart-4)" },
                    { no: "TKT-4214", subj: "User SSO setup help", acc: "Mosaic Group", pr: "Medium", prc: WARN, sla: 0.45, slaT: "9h left", st: "In Prog.", bg: "color-mix(in oklch, var(--illustration-warning) 10%, var(--background))", tc: "var(--illustration-warning)", pw: 48, own: "AL", oc: "var(--illustration-warning)" },
                    { no: "TKT-4213", subj: "Export CSV truncated", acc: "Helix Software", pr: "Medium", prc: WARN, sla: 0.72, slaT: "1d left", st: "Pending", bg: "var(--illustration-panel-alt)", tc: "var(--muted-foreground)", pw: 48, own: "MA", oc: "var(--illustration-success)" },
                ]).map((r, idx) => (
                    <g key={idx}>
                        {Tr(198 + idx * 42, idx % 2 === 0)}
                        ...
                        <rect x={488} y={216 + idx * 42} width="92" height="6" rx="3" fill="var(--illustration-panel-alt)" />
        ...
        case 10: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                {/* Channel tabs */}
                <rect x="36" y="52" width="752" height="36" rx="6" fill="var(--illustration-panel)" stroke={BD} strokeWidth="1" />
                {([
                    { l: "All", n: "1,284", a: true, c: PRM },
                    { l: "Email", n: "942", c: "var(--illustration-info)" },
                    { l: "Calls", n: "184", c: "var(--illustration-success)" },
                    { l: "Meetings", n: "112", c: "var(--illustration-warning)" },
                    { l: "Notes", n: "46", c: "var(--chart-4)" },
                ]).map((tab, ti) => (
                    <g key={ti}>
                ...
                {([
                    { ini: "SC", col: "var(--illustration-info)", from: "Sarah Chen", subj: "Re: Q2 Renewal Proposal", prev: "Thanks for sending the updated quote. We…", time: "2m", unread: true, sel: true, type: "📧" },
                    { ini: "JL", col: "var(--chart-3)", from: "Call · Jordan Lee", subj: "Discovery — Bluepeak Ltd", prev: "Outcome: Qualified. Next step: Send proposal…", time: "1h", unread: false, sel: false, type: "📞" },
                    { ini: "RP", col: "var(--chart-4)", from: "Raj Patel", subj: "Pricing question on Enterprise tier", prev: "Quick question — does the Enterprise plan…", time: "3h", unread: true, sel: false, type: "📧" },
                    { ini: "MS", col: "var(--illustration-success)", from: "Meeting · Bluepeak demo", subj: "Wed 11:00 AM — 45 min", prev: "Attendees: Maya Singh, Jordan Lee. Notes:…", time: "5h", unread: false, sel: false, type: "📅" },
                    { ini: "EL", col: "var(--illustration-warning)", from: "Erik Lund", subj: "Implementation timeline?", prev: "Hi team — we're aiming for end of Q2 go-live…", time: "1d", unread: false, sel: false, type: "📧" },
                    { ini: "AR", col: "var(--chart-5)", from: "Anita Rao", subj: "Demo follow-up", prev: "Following up on yesterday's demo. Sharing…", time: "2d", unread: false, sel: false, type: "📧" },
                ]).map((m, mi) => (
                    <g key={mi}>
                        <rect x="44" y={112 + mi * 58} width="284" height="50" rx="4" fill={m.sel ? "var(--illustration-info-bg)" : W} stroke={m.sel ? "var(--illustration-primary-tint-border)" : BD} strokeWidth="0.5" />
                        {Avatar(58, 132 + mi * 58, m.ini, m.col, 8)}
                        {m.unread && <circle cx={73} cy={120 + mi * 58} r={3} fill="var(--illustration-info)" />}
                ...
                <rect x="360" y="146" width="80" height="16" rx="4" fill="var(--illustration-info-bg)" />
                {T(400, 157, "Linked · Acme", 7.5, true, "var(--illustration-info)", "middle")}
                <rect x="446" y="146" width="76" height="16" rx="4" fill="var(--illustration-success-tint)" />
                {T(484, 157, "Deal · $340K", 7.5, true, "var(--illustration-success)", "middle")}
                {/* Thread messages */}
                {([
                    { ini: "SC", col: "var(--illustration-info)", who: "Sarah Chen", time: "Today 10:14 AM", body: "Thanks for sending the updated quote. We're aligned on the pricing but need to confirm the migration timeline with our IT team.", outbound: false },
                    { ini: "JL", col: "var(--chart-3)", who: "Jordan Lee · You", time: "Today 10:42 AM", body: "Got it — happy to set up a call with our solutions architect this week. How does Thursday 2pm work?", outbound: true },
                    { ini: "SC", col: "var(--illustration-info)", who: "Sarah Chen", time: "Today 11:01 AM", body: "Thursday 2pm works on our side. I'll loop in Mark from IT.", outbound: false },
                ]).map((msg, mi) => (
                    <g key={mi}>
                        <rect x={msg.outbound ? 432 : 372} y={180 + mi * 70} width="340" height="62" rx="6" fill={msg.outbound ? "var(--illustration-info-bg)" : "var(--illustration-panel)"} stroke={msg.outbound ? "var(--illustration-primary-tint-border)" : BD} strokeWidth="0.5" />
                        ...
                        {T(msg.outbound ? 762 : 384, 222 + mi * 70, msg.body.substring(0, 60), 8, false, msg.outbound ? "var(--illustration-info)" : H, msg.outbound ? "end" : "start")}
                        {T(msg.outbound ? 762 : 384, 234 + mi * 70, msg.body.substring(60, 120), 8, false, msg.outbound ? "var(--illustration-info)" : H, msg.outbound ? "end" : "start")}
                    </g>
                ))}
                {/* Reply box */}
                <rect x="360" y="402" width="412" height="48" rx="6" fill="var(--illustration-panel)" stroke={BD} strokeWidth="1" />
        ...
        case 11: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                {(() => {
                    ...
                    const segs = [
                        { v: 0.42, c: "var(--illustration-info)", l: "Webform" },
                        { v: 0.24, c: "var(--chart-4)", l: "Email" },
                        { v: 0.18, c: "var(--illustration-success)", l: "Event" },
                        { v: 0.16, c: "var(--illustration-warning)", l: "LinkedIn" },
                    ];
                    let acc = 0;
                ...
                {/* Legend */}
                {[
                    { l: "Webform", n: "180 leads · 42%", c: "var(--illustration-info)" },
                    { l: "Email cadences", n: "104 leads · 24%", c: "var(--chart-4)" },
                    { l: "Events", n: "76 leads · 18%", c: "var(--illustration-success)" },
                    { l: "LinkedIn ads", n: "68 leads · 16%", c: "var(--illustration-warning)" },
                ].map((lg, li) => (
                    <g key={li}>
                ...
                {([
                    { l: "Reach", v: 24800, w: 1.0, c: "var(--illustration-info)" },
                    { l: "Engaged", v: 4860, w: 0.62, c: "var(--chart-4)" },
                    { l: "Leads", v: 428, w: 0.32, c: "var(--illustration-warning)" },
                    { l: "Qualified", v: 162, w: 0.18, c: "var(--illustration-success)" },
                    { l: "Closed-won", v: 38, w: 0.10, c: "var(--chart-3)" },
                ]).map((f, fi) => {
                    const fullW = 360;
                    const w = fullW * f.w;
        ...
        case 12: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                {([
                    ...
                    <g key={fi}>
                        <rect x="44" y={134 + fi * 30} width="164" height="24" rx="4" fill="var(--illustration-panel)" stroke={BD} strokeWidth="0.5" />
                        <rect x="52" y={140 + fi * 30} width="14" height="14" rx="3" fill="var(--illustration-info-bg)" />
                        {T(59, 151 + fi * 30, f.i, 9, true, "var(--illustration-info)", "middle")}
                        {T(74, 151 + fi * 30, f.l, 9, false, H)}
                    </g>
                ))}
                {/* Form preview */}
                <rect x="228" y="100" width="368" height="364" rx="6" fill="var(--illustration-panel)" stroke={BD} strokeWidth="1" />
                ...
                {[
                    ...
                    <g key={fi}>
                        ...
                        <rect x="264" y={206 + fi * 44} width="296" height={fld.h || 24} rx="4" fill={W} stroke={fi === 1 ? "var(--illustration-info)" : BD} strokeWidth={fi === 1 ? "1" : "0.5"} />
                ...
                {T(624, 140, "Work email *", 8.5, true, "var(--illustration-info)")}
                {[
                ...
                <rect x="616" y="324" width="164" height="64" rx="6" fill="var(--illustration-success-tint)" stroke="var(--illustration-success-tint-border)" strokeWidth="0.5" />
                {T(624, 342, "Submissions", 8, true, "var(--illustration-success)")}
                {T(624, 362, "1,284", 22, true, "var(--illustration-success)")}
                {T(624, 378, "+126 this week", 8.5, false, "var(--illustration-success)")}
                <rect x="616" y="394" width="164" height="58" rx="6" fill="var(--illustration-panel)" stroke={BD} strokeWidth="0.5" />
        ...
        case 13: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                {/* Cadence timeline */}
                <rect x="36" y="130" width="752" height="334" rx="6" fill="var(--illustration-panel)" stroke={BD} strokeWidth="1" />
                {T(52, 150, "Cadence Steps", 11, true, H)}
                {T(776, 150, "Avg send window: 14 days", 9, false, M, "end")}
                {([
                    { day: "Day 0", type: "Email", subj: "Quick intro · Sales acceleration", body: "Hi {{first_name}}, noticed Acme is hiring SDRs…", open: 78, reply: 22, sent: 412, col: "var(--illustration-info)", icon: "📧" },
                    { day: "Day 2", type: "Email", subj: "Re: {{previous_subject}}", body: "Just floating this back to the top of your inbox…", open: 64, reply: 12, sent: 320, col: "var(--illustration-info)", icon: "📧" },
                    { day: "Day 4", type: "Task", subj: "Call · 5-minute pitch", body: "Manual task — call mobile or office line", open: 0, reply: 0, sent: 220, col: "var(--illustration-success)", icon: "📞" },
                    { day: "Day 7", type: "LinkedIn", subj: "Connection request + note", body: "Personalized note based on profile", open: 0, reply: 0, sent: 184, col: "var(--chart-4)", icon: "🔗" },
                    { day: "Day 12", type: "Email", subj: "Last note — closing your file", body: "Wanted to make one final attempt before…", open: 58, reply: 18, sent: 142, col: "var(--illustration-warning)", icon: "📧" },
                ]).map((s, si) => (
                    <g key={si}>
                        ...
                        {/* Stats */}
                        <rect x="632" y={172 + si * 56} width="148" height="44" rx="6" fill="var(--illustration-panel)" stroke={BD} strokeWidth="0.5" />
                        ...
                        {s.reply > 0 && <>{T(740, 184 + si * 56, "Reply %", 7, true, M)}{T(740, 200 + si * 56, s.reply + "%", 12, true, "var(--illustration-info)")}</>}
        ...
        case 14: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                {/* File summary */}
                <rect x="36" y="100" width="752" height="48" rx="6" fill="var(--illustration-info-bg)" stroke="var(--illustration-primary-tint-border)" strokeWidth="1" />
                <rect x="48" y="112" width="24" height="24" rx="4" fill="var(--illustration-info)" />
                {T(60, 129, "📄", 12, false, W, "middle")}
                {T(84, 122, "contacts_april.csv", 11, true, "var(--illustration-info)")}
                {T(84, 138, "1,284 rows · 12 columns · UTF-8 encoded", 8.5, false, "var(--illustration-info)")}
                <rect x="650" y="110" width="60" height="14" rx="3" fill="var(--illustration-success-tint)" />
                {T(680, 120, "Valid ✓", 8, true, "var(--illustration-success)", "middle")}
                <rect x="716" y="110" width="60" height="14" rx="3" fill="color-mix(in oklch, var(--illustration-warning) 10%, var(--background))" />
                {T(746, 120, "12 dupes", 8, true, "var(--illustration-warning)", "middle")}
                {T(776, 138, "Last imported: 14 days ago · 1,012 records", 8, false, "var(--illustration-info)", "end")}
                {/* Mapping table */}
                <rect x="36" y="160" width="752" height="304" rx="6" fill={W} stroke={BD} strokeWidth="1" />
                <rect x="36" y="160" width="752" height="32" rx="6" fill="var(--illustration-panel)" />
                <rect x="36" y="184" width="752" height="8" fill="var(--illustration-panel)" />
                ...
                {([
                    ...
                    <g key={idx}>
                        <rect x="44" y={202 + idx * 30} width="736" height="26" rx="3" fill={idx % 2 === 0 ? W : "var(--illustration-panel)"} stroke={BD} strokeWidth="0.3" />
                        {T(56, 218 + idx * 30, r.col, 9, true, PRM)}
                        {T(248, 218 + idx * 30, r.samp, 9, false, M)}
                        {T(456, 218 + idx * 30, "→", 12, true, BD, "middle")}
                        <rect x="488" y={208 + idx * 30} width="200" height="14" rx="3" fill={r.ok ? W : "var(--illustration-panel-alt)"} stroke={r.ok ? "var(--illustration-primary-tint-border)" : BD} strokeWidth="0.5" />
                        {T(496, 218 + idx * 30, r.map, 8.5, false, r.ok ? "var(--illustration-info)" : M)}
                        {T(680, 218 + idx * 30, "▾", 8, true, M, "end")}
                        {r.ok ? (
                            <>
                                <circle cx={728} cy={215 + idx * 30} r={6} fill="var(--illustration-success-tint)" />
                                <text x={728} y={219 + idx * 30} fontFamily={ff} fontSize="9" fontWeight="700" fill="var(--illustration-success)" textAnchor="middle">✓</text>
                            </>
                        ) : (
                            <>
                                <circle cx={728} cy={215 + idx * 30} r={6} fill="var(--illustration-panel-alt)" />
                                <text x={728} y={219 + idx * 30} fontFamily={ff} fontSize="9" fontWeight="700" fill="var(--muted-foreground)" textAnchor="middle">−</text>
                            </>
                        )}
                    </g>
                ))}
        ...
        case 15: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                {(["MON 26", "TUE 27", "WED 28", "THU 29", "FRI 30", "SAT 1", "SUN 2"]).map((d, di) => (
                    <g key={di}>
                        <rect x={88 + di * 102} y="100" width="100" height="28" rx="0" fill={di === 2 ? "var(--illustration-info-bg)" : W} stroke={BD} strokeWidth="0.5" />
                        {T(138 + di * 102, 118, d, 8.5, di === 2, di === 2 ? "var(--illustration-info)" : M, "middle")}
                    </g>
                ))}
                {/* Time column */}
                ...
                {/* Events */}
                {([
                    { d: 0, t: 0, dur: 1, name: "Discovery · Acme Corp", col: "var(--illustration-info)", bg: "var(--illustration-info-bg)" },
                    { d: 0, t: 4, dur: 1, name: "Demo · TechStart", col: "var(--illustration-success)", bg: "var(--illustration-success-tint)" },
                    { d: 1, t: 1, dur: 2, name: "Quote review · Q-0184", col: "var(--illustration-warning)", bg: "color-mix(in oklch, var(--illustration-warning) 10%, var(--background))" },
                    { d: 2, t: 0, dur: 1, name: "Standup · Sales team", col: "var(--chart-4)", bg: "color-mix(in oklch, var(--chart-4) 8%, var(--background))" },
                    { d: 2, t: 3, dur: 2, name: "Close call · Mosaic", col: "var(--illustration-success)", bg: "var(--illustration-success-tint)" },
                    { d: 3, t: 2, dur: 1, name: "Cadence review", col: "var(--chart-3)", bg: "color-mix(in oklch, var(--chart-3) 10%, var(--background))" },
                    { d: 3, t: 6, dur: 1, name: "1:1 · Manager", col: "var(--chart-5)", bg: "color-mix(in oklch, var(--chart-5) 8%, var(--background))" },
                    { d: 4, t: 1, dur: 1, name: "QBR · Acme", col: "var(--illustration-info)", bg: "var(--illustration-info-bg)" },
                    { d: 4, t: 5, dur: 2, name: "Pipeline review", col: "var(--illustration-warning)", bg: "color-mix(in oklch, var(--illustration-warning) 10%, var(--background))" },
                ]).map((e, ei) => (
                    <g key={ei}>
        ...
        case 16: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                {/* Tasks list */}
                {([
                    { done: false, name: "Call Sarah Chen — confirm migration timeline", rec: "Deal · Acme Q2 Renewal", due: "Today 11:00", dueC: WARN, pr: "High", prc: NEG, icon: "📞", iconC: "var(--illustration-success)", own: "JL", oc: "var(--chart-3)" },
                    { done: false, name: "Send proposal — Bluepeak migration", rec: "Deal · Bluepeak", due: "Today 2:00 PM", dueC: WARN, pr: "High", prc: NEG, icon: "📧", iconC: "var(--illustration-info)", own: "JL", oc: "var(--chart-3)" },
                    { done: false, name: "Follow up on quote Q-2026-0181", rec: "Quote · Nordic AB", due: "Today 4:30 PM", dueC: WARN, pr: "Med", prc: WARN, icon: "📞", iconC: "var(--illustration-success)", own: "EL", oc: "var(--illustration-warning)" },
                    { done: false, name: "Demo prep — Voltline deep dive", rec: "Account · Voltline", due: "Tomorrow", dueC: M, pr: "Med", prc: WARN, icon: "📋", iconC: "var(--chart-4)", own: "JL", oc: "var(--chart-3)" },
                    { done: false, name: "Renewal reminder — TechStart Inc", rec: "Account · TechStart", due: "Apr 28", dueC: M, pr: "Med", prc: WARN, icon: "📧", iconC: "var(--illustration-info)", own: "RP", oc: "var(--chart-4)" },
                    { done: true, name: "Onboarding kickoff — Mosaic Group", rec: "Account · Mosaic", due: "Done · Apr 25", dueC: POS, pr: "Low", prc: M, icon: "✓", iconC: "var(--illustration-success)", own: "JL", oc: "var(--chart-3)" },
                    { done: true, name: "Quarterly business review — Acme", rec: "Account · Acme", due: "Done · Apr 24", dueC: POS, pr: "High", prc: NEG, icon: "✓", iconC: "var(--illustration-success)", own: "JL", oc: "var(--chart-3)" },
                ]).map((t, ti) => (
                    <g key={ti}>
                        <rect x="36" y={176 + ti * 40} width="752" height="34" rx="5" fill={ti % 2 === 0 ? W : "var(--illustration-panel)"} stroke={BD} strokeWidth="0.5" />
                        ...
                        <rect x="446" y={186 + ti * 40} width="100" height="18" rx="4" fill={t.dueC === WARN ? "color-mix(in oklch, var(--illustration-warning) 10%, var(--background))" : t.dueC === POS ? "var(--illustration-success-tint)" : "var(--illustration-panel-alt)"} />
                        {T(496, 198 + ti * 40, t.due, 8, true, t.dueC === WARN ? "var(--illustration-warning)" : t.dueC === POS ? "var(--illustration-success)" : "var(--muted-foreground)", "middle")}
        ...
        case 17: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                {([
                    { type: "Note", title: "Discovery call recap", who: "JL", col: "var(--chart-3)", time: "2h ago", sel: true, icon: "📝" },
                    { type: "Doc", title: "Q2_proposal_v3.pdf", who: "SC", col: "var(--illustration-info)", time: "1d ago", sel: false, icon: "📄" },
                    { type: "Note", title: "Pricing objection — counter $48K", who: "JL", col: "var(--chart-3)", time: "2d ago", sel: false, icon: "📝" },
                    { type: "Doc", title: "MSA_redlined.docx", who: "Legal", col: "var(--chart-4)", time: "3d ago", sel: false, icon: "📄" },
                    { type: "Note", title: "Stakeholder map", who: "JL", col: "var(--chart-3)", time: "5d ago", sel: false, icon: "📝" },
                    { type: "Doc", title: "Security_questionnaire.xlsx", who: "Sec", col: "var(--illustration-success)", time: "1w ago", sel: false, icon: "📊" },
                    { type: "Note", title: "Competitor mentions — Salesforce", who: "MR", col: "var(--illustration-warning)", time: "1w ago", sel: false, icon: "📝" },
                ]).map((n, ni) => (
                    <g key={ni}>
                        <rect x="44" y={86 + ni * 48} width="224" height="44" rx="5" fill={n.sel ? "var(--illustration-info-bg)" : W} stroke={n.sel ? "var(--illustration-primary-tint-border)" : BD} strokeWidth="0.5" />
                ...
                <rect x="288" y="52" width="500" height="40" rx="6" fill="var(--illustration-panel)" />
                <rect x="288" y="86" width="500" height="6" fill="var(--illustration-panel)" />
                ...
                {/* Toolbar */}
                <rect x="304" y="104" width="468" height="28" rx="4" fill="var(--illustration-panel)" stroke={BD} strokeWidth="0.5" />
                {(["B", "I", "U", "≡", "•", "1.", "🔗", "@"]).map((b, bi) => (
                    <g key={bi}>
                ...
                {/* Mentions/tags */}
                <rect x="304" y="368" width="100" height="20" rx="4" fill="var(--illustration-info-bg)" />
                {T(354, 381, "@Mark Klein", 8.5, true, "var(--illustration-info)", "middle")}
                <rect x="412" y="368" width="80" height="20" rx="4" fill="color-mix(in oklch, var(--chart-4) 8%, var(--background))" />
                {T(452, 381, "#discovery", 8.5, true, "var(--chart-4)", "middle")}
                {/* Attachments */}
                {T(304, 408, "Attached files (2)", 9, true, H)}
                <rect x="304" y="416" width="220" height="38" rx="5" fill="var(--illustration-panel)" stroke={BD} strokeWidth="0.5" />
                <rect x="312" y="424" width="22" height="22" rx="3" fill="color-mix(in oklch, var(--destructive) 12%, var(--background))" />
                {T(323, 440, "📄", 12, false, "var(--destructive)", "middle")}
                {T(342, 432, "Q2_proposal_v3.pdf", 8.5, true, H)}
                {T(342, 444, "1.2 MB · PDF", 7.5, false, M)}
                <rect x="544" y="416" width="220" height="38" rx="5" fill="var(--illustration-panel)" stroke={BD} strokeWidth="0.5" />
                <rect x="552" y="424" width="22" height="22" rx="3" fill="var(--illustration-info-bg)" />
                {T(563, 440, "📄", 12, false, "var(--illustration-info)", "middle")}
        ...
        case 18: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                <rect x="44" y="82" width="164" height="22" rx="4" fill="var(--illustration-panel)" stroke={BD} strokeWidth="0.5" />
                ...
                {([
                    ...
                    <g key={fi}>
                        <rect x={44 + (fi % 2) * 84} y={132 + Math.floor(fi / 2) * 32} width="80" height="28" rx="4" fill="var(--illustration-panel)" stroke={BD} strokeWidth="0.5" />
                        <rect x={52 + (fi % 2) * 84} y={140 + Math.floor(fi / 2) * 32} width="16" height="14" rx="3" fill="var(--illustration-info-bg)" />
                        {T(60 + (fi % 2) * 84, 151 + Math.floor(fi / 2) * 32, f.i, 8.5, true, "var(--illustration-info)", "middle")}
                ...
                {([
                    ...
                    <g key={fi}>
                        <rect x={44 + (fi % 2) * 84} y={290 + Math.floor(fi / 2) * 32} width="80" height="28" rx="4" fill="var(--illustration-panel)" stroke={BD} strokeWidth="0.5" />
                        <rect x={52 + (fi % 2) * 84} y={298 + Math.floor(fi / 2) * 32} width="16" height="14" rx="3" fill="color-mix(in oklch, var(--chart-4) 8%, var(--background))" />
                        {T(60 + (fi % 2) * 84, 309 + Math.floor(fi / 2) * 32, f.i, 8.5, true, "var(--chart-4)", "middle")}
                        {T(74 + (fi % 2) * 84, 310 + Math.floor(fi / 2) * 32, f.l, 8.5, false, H)}
                    </g>
                ))}
                {/* Layout canvas */}
                <rect x="228" y="52" width="396" height="412" rx="6" fill="var(--illustration-panel)" stroke={BD} strokeWidth="1" />
                ...
                <rect x="240" y="86" width="372" height="24" rx="6" fill="var(--illustration-info-bg)" />
                <rect x="240" y="106" width="372" height="4" fill="var(--illustration-info-bg)" />
                {T(252, 102, "▾ General Information", 9, true, "var(--illustration-info)")}
                {T(602, 102, "⋮⋮", 9, true, "var(--illustration-info)", "end")}
                {/* Fields grid */}
                {([
                    ...
                    <g key={fi}>
                        <rect x={f.x} y={f.y} width="172" height="32" rx="4" fill="var(--illustration-panel)" stroke={BD} strokeWidth="0.5" />
                ...
                <rect x="240" y="256" width="372" height="24" rx="6" fill="color-mix(in oklch, var(--chart-4) 8%, var(--background))" />
                <rect x="240" y="276" width="372" height="4" fill="color-mix(in oklch, var(--chart-4) 8%, var(--background))" />
                {T(252, 272, "▾ Custom Fields", 9, true, "var(--chart-4)")}
                {T(602, 272, "⋮⋮", 9, true, "var(--chart-4)", "end")}
                {([
                    ...
                    <g key={fi}>
                        <rect x={f.x} y={f.y} width={fi === 6 ? 356 : 172} height="32" rx="4" fill="var(--illustration-panel)" stroke={fi === 0 ? "color-mix(in oklch, var(--chart-4) 35%, var(--border))" : BD} strokeWidth={fi === 0 ? "1" : "0.5"} />
                        {T(f.x + 8, f.y + 12, f.l, 7.5, true, M)}
                        {T(f.x + 8, f.y + 26, f.v, 9, false, H)}
                        {fi === 0 && <circle cx={f.x + 168} cy={f.y + 16} r={3} fill="var(--chart-4)" />}
                    </g>
                ))}
                {/* Field properties */}
                <rect x="636" y="52" width="152" height="412" rx="6" fill={W} stroke={BD} strokeWidth="1" />
                {T(648, 72, "Field Properties", 10, true, H)}
                <rect x="644" y="86" width="136" height="22" rx="4" fill="color-mix(in oklch, var(--chart-4) 8%, var(--background))" />
                {T(652, 100, "Buyer Persona", 8.5, true, "var(--chart-4)")}
                {[
        ...
        case 19: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                <rect x="44" y="84" width="304" height="370" rx="6" fill="var(--illustration-panel)" stroke={BD} strokeWidth="0.5" />
                ...
                <rect x="232" y="124" width="100" height="20" rx="4" fill="var(--illustration-panel-alt)" stroke={BD} strokeWidth="0.5" />
                ...
                {/* Function log */}
                <rect x="52" y="324" width="288" height="120" rx="5" fill="var(--foreground)" stroke={BD} strokeWidth="0.5" />
                {T(64, 342, "EXECUTION LOG", 7.5, true, "var(--muted-foreground)")}
                {[
                    { l: "[10:42:18] Function syncDealToHubspot()", c: "var(--chart-3)" },
                    { l: "[10:42:18] Fetched record DEAL-0042", c: "var(--chart-3)" },
                    { l: "[10:42:19] POST → api.hubapi.com/deals", c: "var(--illustration-info)" },
                    { l: "[10:42:19] ↳ Status 200 · 248ms", c: "var(--illustration-success)" },
                    { l: "[10:42:19] Deal synced · ID 8421-XYZ", c: "var(--illustration-success)" },
                    { l: "[10:42:19] ✓ Function completed (1.2s)", c: "var(--illustration-success)" },
                ].map((l, li) => T(64, 358 + li * 14, l.l, 7, false, l.c))
                }
                {/* Code editor */}
                <rect x="368" y="52" width="420" height="412" rx="6" fill="var(--foreground)" stroke={BD} strokeWidth="1" />
                {T(384, 72, "syncDealToHubspot.js", 9, true, "var(--chart-3)")}
                <rect x="700" y="60" width="76" height="20" rx="4" fill="var(--illustration-success)" />
                {T(738, 73, "Run Function", 8.5, true, W, "middle")}
                {/* Code lines */}
                {([
                    { ln: 1, c: "async function ", cc: "var(--chart-4)", c2: "syncDealToHubspot", cc2: "var(--illustration-info)", c3: "({ record, client }) {", cc3: "var(--border)" },
                    { ln: 2, c: "  const ", cc: "var(--chart-4)", c2: "deal", cc2: "var(--illustration-info)", c3: " = record.opportunity;", cc3: "var(--border)" },
                    { ln: 3, c: "  ", cc: "var(--chart-4)", c2: "", cc2: "var(--illustration-info)", c3: "", cc3: "var(--border)" },
                    { ln: 4, c: "  // Map CRM fields to HubSpot schema", cc: "var(--muted-foreground)", c2: "", cc2: "", c3: "", cc3: "" },
                    { ln: 5, c: "  const ", cc: "var(--chart-4)", c2: "payload", cc2: "var(--illustration-info)", c3: " = {", cc3: "var(--border)" },
                    { ln: 6, c: "    dealname: deal.name,", cc: "var(--border)", c2: "", cc2: "", c3: "", cc3: "" },
                    { ln: 7, c: "    amount: deal.amount,", cc: "var(--border)", c2: "", cc2: "", c3: "", cc3: "" },
                    { ln: 8, c: "    closedate: deal.expectedCloseDate,", cc: "var(--border)", c2: "", cc2: "", c3: "", cc3: "" },
                    { ln: 9, c: "    dealstage: ", cc: "var(--border)", c2: "mapStage", cc2: "var(--illustration-info)", c3: "(deal.stage),", cc3: "var(--border)" },
                    { ln: 10, c: "  };", cc: "var(--border)", c2: "", cc2: "", c3: "", cc3: "" },
                    { ln: 11, c: "  ", cc: "var(--border)", c2: "", cc2: "", c3: "", cc3: "" },
                    { ln: 12, c: "  // POST to HubSpot v3 deals API", cc: "var(--muted-foreground)", c2: "", cc2: "", c3: "", cc3: "" },
                    { ln: 13, c: "  const ", cc: "var(--chart-4)", c2: "res", cc2: "var(--illustration-info)", c3: " = await client.fetch(", cc3: "var(--border)" },
                    { ln: 14, c: "    ", cc: "var(--border)", c2: "\"https://api.hubapi.com/v3/objects/deals\"", cc2: "var(--illustration-success-tint-border)", c3: ",", cc3: "var(--border)" },
                    { ln: 15, c: "    { method: ", cc: "var(--border)", c2: "\"POST\"", cc2: "var(--illustration-success-tint-border)", c3: ", body: payload }", cc3: "var(--border)" },
                    { ln: 16, c: "  );", cc: "var(--border)", c2: "", cc2: "", c3: "", cc3: "" },
                    { ln: 17, c: "  return { id: res.id, synced: ", cc: "var(--border)", c2: "true", cc2: "var(--illustration-warning)", c3: " };", cc3: "var(--border)" },
                    { ln: 18, c: "}", cc: "var(--border)", c2: "", cc2: "", c3: "", cc3: "" },
                ]).map((row, ri) => (
                    <g key={ri}>
                        <text x="384" y={102 + ri * 18} fontFamily="ui-monospace,monospace" fontSize="8" fill="var(--muted-foreground)">{String(row.ln).padStart(2, " ")}</text>
                ...
                <rect x="376" y="430" width="404" height="28" rx="5" fill="var(--illustration-nav)" stroke="var(--muted-foreground)" strokeWidth="0.5" />
                {T(388, 448, "✓ Saved · Deployed · 1.2s avg runtime · 142 executions today", 8.5, true, "var(--illustration-success)")}
            </svg>
        );
        ...
        case 20: return (
            <svg viewBox="0 0 800 480" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
                ...
                {([
                    { name: "HubSpot — Contacts sync", url: "hooks.hubspot.com/...", events: "contact.created, contact.updated", st: "Active", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 40 },
                    { name: "Slack — #sales-alerts", url: "hooks.slack.com/T0...", events: "deal.won, deal.stage_changed", st: "Active", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 40 },
                    { name: "Zapier — Lead capture", url: "hooks.zapier.com/...", events: "lead.created", st: "Active", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 40 },
                    { name: "Internal API — Billing", url: "api.acme.com/crm-events", events: "invoice.paid, invoice.overdue", st: "Active", bg: "var(--illustration-success-tint)", tc: "var(--illustration-success)", pw: 40 },
                    { name: "Make.com — Marketing", url: "hook.eu1.make.com/...", events: "contact.tag_added", st: "Paused", bg: "color-mix(in oklch, var(--illustration-warning) 10%, var(--background))", tc: "var(--illustration-warning)", pw: 44 },
                ]).map((w, wi) => (
                    <g key={wi}>
                        <rect x="44" y={166 + wi * 58} width="364" height="50" rx="5" fill={W} stroke={BD} strokeWidth="0.5" />
                        <rect x="52" y={174 + wi * 58} width="18" height="34" rx="4" fill={wi === 4 ? "color-mix(in oklch, var(--illustration-warning) 10%, var(--background))" : "var(--illustration-info-bg)"} />
                        {T(61, 195 + wi * 58, "→", 12, true, wi === 4 ? "var(--illustration-warning)" : "var(--illustration-info)", "middle")}
                        {T(78, 184 + wi * 58, w.name, 9.5, true, H)}
                        {T(78, 196 + wi * 58, w.url, 8, false, M)}
                        {T(78, 208 + wi * 58, w.events, 7.5, false, "var(--illustration-info)")}
                ...
                {([
                    ...
                    <g key={di}>
                        <rect x="436" y={170 + di * 30} width="344" height="26" rx="3" fill={di % 2 === 0 ? W : "var(--illustration-panel)"} stroke={BD} strokeWidth="0.3" />
                        ...
                        <rect x={736} y={177 + di * 30} width="36" height="14" rx="3" fill={d.ok ? "var(--illustration-success-tint)" : "color-mix(in oklch, var(--destructive) 8%, var(--background))"} />
                        {T(754, 187 + di * 30, d.st, 8, true, d.ok ? "var(--illustration-success)" : "var(--destructive)", "middle")}
                    </g>
                ))}
