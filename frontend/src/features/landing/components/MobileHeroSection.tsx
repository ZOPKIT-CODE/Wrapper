...
const T = {
  ...
  inkSoft: '#3A4674',
  muted: '#7C84A0',
  borderLight: 'rgba(19,32,74,0.07)',
  panelLight: '#F7F8FA',
  cardLight: '#FFFFFF',
  green: '#4DC18A',
}
...
const DESC: Record<string, string> = {
  'B2B CRM':
    'Scoring inbound leads & auto-assigning follow-ups based on deal size',
  Finance:
    'Reconciling transactions, filing GST returns & projecting cash flow',
  HRMS: 'Tracking attendance, running payroll & surfacing compliance alerts',
  Projects:
    'Monitoring sprint health, detecting blockers & reallocating bandwidth',
}
...
function HDConnectors() {
  return (
    ...
    >
      ...
      {/* TL card → monitor */}
      <path
        d="M 220 540 C 280 540 300 600 340 600"
        stroke="url(#mhc1)"
        strokeWidth="2"
        fill="none"
      />
      {/* BL card → monitor */}
      <path
        d="M 220 910 C 280 910 300 850 340 850"
        stroke="url(#mhc2)"
        strokeWidth="2"
        fill="none"
      />
      {/* TR card → monitor */}
      <path
        d="M 1220 540 C 1160 540 1140 600 1100 600"
        stroke="url(#mhc3)"
        strokeWidth="2"
        fill="none"
      />
      {/* BR card → monitor */}
      <path
        d="M 1220 910 C 1160 910 1140 850 1100 850"
        stroke="url(#mhc4)"
        strokeWidth="2"
        fill="none"
      />
      <circle cx="220" cy="540" r="3.5" fill={BLUE} fillOpacity="0.85" />
      <circle cx="220" cy="910" r="3.5" fill={BLUE} fillOpacity="0.85" />
      <circle cx="1220" cy="540" r="3.5" fill={BLUE} fillOpacity="0.85" />
      <circle cx="1220" cy="910" r="3.5" fill={BLUE} fillOpacity="0.85" />
    </svg>
  )
}
          ...
          {Array.from({ length: 12 }).map((_, i) => (
            <div
              ...
              style={{
                ...
                borderRadius: 1.5,
                background:
                  ((i + 1) / 12) * 100 <= pct ? accent : 'rgba(19,32,74,0.08)',
              }}
            />
          ))}
        </div>
      ...
      >
        ...
        >
              ...
              >
                ...
                <div
                  style={{
                    ...
                    borderRadius: 2.5,
                    background:
                      i === 1 ? 'rgba(19,32,74,0.18)' : 'rgba(19,32,74,0.07)',
                  }}
                />
              </div>
            ))}
          ...
          >
            ...
            <div
              style={{
                background: 'rgba(27,71,180,0.04)',
                border: '1px solid rgba(27,71,180,0.14)',
                borderRadius: 11,
                padding: '12px 14px',
              }}
            >
              ...
              >
                <div style={{ display: 'flex', gap: 10 }}>
                  <div
                    style={{
                      ...
                      height: 34,
                      borderRadius: 7,
                      background: 'rgba(27,71,180,0.10)',
                      border: '1px solid rgba(27,71,180,0.25)',
                      display: 'grid',
                      placeItems: 'center',
                    }}
                  >
                ...
                <div
                  style={{
                    padding: '4px 9px',
                    borderRadius: 5,
                    background: 'rgba(27,71,180,0.08)',
                    border: '1px solid rgba(27,71,180,0.22)',
                    fontFamily: landingFonts.mono,
                    fontSize: 10,
                    color: BLUE,
                  }}
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: '50%',
          background:
            'radial-gradient(circle at 50% 25%, #1a2540 0%, #0a0e1f 65%, #000 100%)',
          boxShadow:
            '0 24px 50px rgba(0,0,0,0.4), inset 0 -8px 18px rgba(0,0,0,0.6)',
        }}
      >
        <div
          style={{
            ...
            borderRadius: '50%',
            background:
              'radial-gradient(ellipse, rgba(180,210,255,0.85), rgba(91,141,239,0.4) 50%, transparent 80%)',
            filter: 'blur(2px)',
          }}
        />
      </div>
...
// Fixed navbar height — keeps the composition below the pill navbar.
