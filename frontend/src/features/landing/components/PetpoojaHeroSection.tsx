...
/** Shared ink palette for illustration chrome (geometry unchanged). */
const INK = {
  base: '#13204A',
  soft: 'rgba(19,32,74,0.52)',
  muted: 'rgba(19,32,74,0.36)',
  faint: 'rgba(19,32,74,0.24)',
  border: 'rgba(19,32,74,0.07)',
  borderMd: 'rgba(19,32,74,0.10)',
  wash: 'rgba(19,32,74,0.04)',
  washMd: 'rgba(19,32,74,0.06)',
  panel: '#F7F8FA',
  accentWash: 'rgba(27,46,90,0.05)',
  accentBorder: 'rgba(27,46,90,0.16)',
}
...
const AGENTS = [
  ...
  },
  {
    ...
    source: 'HRMS',
    color: BLUE,
    metric1: '284 Employees',
    metric2: '98% Attendance',
...
const AGENT_FEEDS = [
  [
    'Lead scored: Sharma & Co ₹8.4L',
    'Follow-up queued: 12 accts',
    'Pipeline updated: +18%',
  ],
  [
    'GST R1 filed: Aug 2025',
    'Invoice #1247 reconciled',
    'Cash flow projection synced',
  ],
  [
    'PO #847 approved: ₹2.3L',
    'SKU-224 low stock alert',
    'Vendor pmt queued: 3 items',
  ],
  [
    'Payroll: 284 emp processed',
    'Leave approved: 7 requests',
    'Compliance check: Clear',
  ],
  [
    'Sprint 14: 3 blockers fixed',
    'Alpha delivery: updated ETA',
    'Budget utilised: 82%',
  ],
] as const
...
const AGENT_INTEGRATIONS = [
  [
    { label: 'CRM', c: BLUE },
    { label: 'Email', c: BLUE },
    { label: 'WhatsApp', c: BLUE },
  ],
  [
    { label: 'Tally', c: BLUE },
    { label: 'GST Portal', c: BLUE },
    { label: 'Banking', c: BLUE },
  ],
  [
    { label: 'POS', c: BLUE },
    { label: 'Inventory', c: BLUE },
    { label: 'Warehouse', c: BLUE },
  ],
  [
    { label: 'ESIC', c: BLUE },
    { label: 'PF Portal', c: BLUE },
    { label: 'Attendance', c: BLUE },
  ],
  [
    { label: 'Tasks', c: BLUE },
    { label: 'Git', c: BLUE },
    { label: 'Time Track', c: BLUE },
  ],
] as const
  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#rb-clip)" opacity="0.92">
        <path
          d="M 28,10 Q 50,4 72,10 Q 68,30 60,36 Q 50,28 40,36 Q 32,30 28,10Z"
          fill="url(#rb-panel-a)"
          stroke="#06080d"
          strokeWidth="0.9"
        />
        <path
          d="M 26,90 Q 50,96 74,90 Q 70,70 62,64 Q 50,72 38,64 Q 30,70 26,90Z"
          fill="url(#rb-panel-b)"
          stroke="#06080d"
          strokeWidth="0.9"
        />
        <path
          d="M 70,10 Q 92,26 95,50 Q 82,54 74,48 Q 76,34 66,22 Z"
          fill="url(#rb-panel-a)"
          stroke="#06080d"
          strokeWidth="0.9"
        />
        <path
          d="M 95,50 Q 92,74 70,90 Q 66,78 74,66 Q 82,60 74,48 Z"
          fill="url(#rb-panel-b)"
          stroke="#06080d"
          strokeWidth="0.9"
        />
        <path
          d="M 30,10 Q 8,26 5,50 Q 18,54 26,48 Q 24,34 34,22 Z"
          fill="url(#rb-panel-a)"
          stroke="#06080d"
          strokeWidth="0.9"
        />
        <path
          d="M 5,50 Q 8,74 30,90 Q 34,78 26,66 Q 18,60 26,48 Z"
          fill="url(#rb-panel-b)"
          stroke="#06080d"
          strokeWidth="0.9"
        />
        <path
          d="M 28,10 Q 50,4 72,10"
          fill="none"
          stroke="rgba(130,150,180,0.18)"
          strokeWidth="0.7"
        />
        <path
          d="M 70,10 Q 92,26 95,50"
          fill="none"
          stroke="rgba(130,150,180,0.12)"
          strokeWidth="0.7"
        />
        <path
          d="M 5,50  Q 8,26  30,10"
          fill="none"
          stroke="rgba(130,150,180,0.12)"
          strokeWidth="0.7"
        />
      ...
      {([0, 45, 90, 135, 180, 225, 270, 315] as const).map((deg, i) => {
        ...
        return (
          <circle
            key={i}
            cx={62 + 19.5 * Math.cos(r)}
            cy={50 + 19.5 * Math.sin(r)}
            r="0.9"
            fill="#2e3848"
          />
        )
      ...
      <ellipse
        ...
        ry="13"
        fill="url(#rb-spec)"
        transform="rotate(-18,36,24)"
        clipPath="url(#rb-clip)"
      />
      <circle
        cx="50"
        cy="50"
        r="46"
        fill="none"
        stroke="rgba(80,120,200,0.22)"
        strokeWidth="1.2"
        clipPath="url(#rb-clip)"
      />
      <path
        d="M 14,28 Q 8,50 14,72"
        fill="none"
        stroke="rgba(100,150,230,0.18)"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
    </svg>
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow:
            '0 0 0 2px rgba(70,120,230,0.55), 0 0 20px 10px rgba(40,70,160,0.38), 0 0 44px 22px rgba(27,46,90,0.18)',
          zIndex: 10,
        }}
      />
      ...
      {(
        [
          {
            ...
            glow: 'rgba(100,180,255,0.55)',
          },
          {
            t: 0.07,
            color: 'rgba(120,190,255,0.80)',
            glow: 'rgba(80,150,240,0.40)',
          },
          {
            t: 0.14,
            color: 'rgba(80,155,240,0.65)',
        ...
        <motion.div
          ...
          transition={{
            duration: BALL_DUR,
            delay: BALL_DELAY + t,
            times: [0, 0.62, 0.68, 0.74, 0.9, 1.0],
            ease: 'easeOut',
          }}
          style={{
            position: 'absolute',
        ...
        >
            ...
            {SIDEBAR_ITEMS.map((item, i) => (
              <div
                ...
                style={{
                  ...
                  gap: 5,
                  padding: '4px 5px',
                  background: item.active ? INK.washMd : 'transparent',
                  borderRadius: 3,
              ...
              >
                ...
                <div
                  style={{
                    height: 3,
                    flex: 1,
                    background: item.active ? 'rgba(19,32,74,0.62)' : INK.faint,
                    borderRadius: 1,
                  }}
                />
              </div>
          ...
          >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <div
                  style={{
                    ...
                    alignItems: 'center',
                    gap: 4,
                    background: INK.washMd,
                    border: `1px solid ${INK.borderMd}`,
                    borderRadius: 100,
                    padding: '2px 8px',
                  }}
                >
                  ...
                  />
                  <span style={TX('rgba(46,79,140,0.82)', 7, 600)}>
                    5 Agents Running
                  </span>
                </div>
              </div>
              <span style={TX(INK.muted, 7)}>Live Sync</span>
            </div>
            ...
            >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <span style={TX('rgba(27,71,180,0.75)', 7, 500)}>
                        Decision Engine Active
                      </span>
                    </div>
                  </div>
                  <span style={TX(INK.soft, 6.5)}>
                    Aggregating sub-agent reports • Taking cross-system
                    decisions
                  </span>
                </div>
                <div
              ...
              >
                <span style={TX(BLUE, 6.5, 600)}>DECISION</span>
                <span style={TX(INK.base, 7)}>Increase Q2 inventory 18%</span>
                <span style={{ ...TX(INK.faint, 7), margin: '0 2px' }}>•</span>
                <span style={TX(INK.base, 7)}>Approve ₹32L payroll</span>
                <span style={{ ...TX(INK.faint, 7), margin: '0 2px' }}>•</span>
                <span style={TX(INK.base, 7)}>Flag 3 CRM leads</span>
              </div>
            </div>
              ...
              {AGENTS.map((agent, agentIdx) => (
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        ...
                        />
                        <span style={TX(INK.soft, 6)}>Active</span>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <span style={TX(INK.muted, 6)}>{agent.progress}%</span>
                  </div>
                  {/* Live activity feed */}
                  <div
                    style={{
                  ...
                  >
                    ...
                    {AGENT_FEEDS[agentIdx].map((item, fi) => (
                      ...
                      >
                        ...
                        />
                        <span
                          style={{ ...TX(INK.soft, 5.5), lineHeight: 1.35 }}
                        >
                          {item}
                        </span>
                      </div>
                      ...
                      {AGENT_INTEGRATIONS[agentIdx].map((intg, ii) => (
                        <div
                          ...
                          style={{
                            ...
                            alignItems: 'center',
                            gap: 2.5,
                            background: `${intg.c}10`,
                            border: `1px solid ${intg.c}30`,
                            borderRadius: 3,
                            padding: '1.5px 5px',
                          }}
                        >
...
function LightCone() {
  return (
    <motion.div
      ...
      className="landing-hero-illust-cone"
      style={{
        position: 'absolute',
        inset: 0,
        pointerEvents: 'none',
    ...
    >
      <svg
        ...
        style={{
          display: 'block',
          animation: 'pp-cone-breath 3.5s ease-in-out infinite',
        }}
      >
        <defs>
          <linearGradient
          ...
          <filter id="pp-f-soft" x="-30%" y="-15%" width="160%" height="145%">
            <feGaussianBlur stdDeviation="2 1.2" />
          </filter>
          <filter id="pp-f-wide" x="-50%" y="-15%" width="200%" height="145%">
            <feGaussianBlur stdDeviation="6 3.5" />
          </filter>
          <filter id="pp-f-ray" x="-200%" y="-30%" width="500%" height="160%">
            <feGaussianBlur stdDeviation="0.6 0.3" />
          </filter>
          <filter id="pp-f-glow" x="-200%" y="-30%" width="500%" height="160%">
            <feGaussianBlur stdDeviation="1.5 0.8" />
          </filter>
          <filter id="pp-f-edge" x="-20%" y="-200%" width="140%" height="500%">
            <feGaussianBlur stdDeviation="0.8 2.5" />
          </filter>
          <filter id="pp-f-halo" x="-100%" y="-100%" width="300%" height="300%">
        ...
        <ellipse
          ...
          rx="7"
          ry="2.5"
          fill="url(#pp-src-halo)"
          filter="url(#pp-f-halo)"
        />
...
function Projector({ isMobile }: { isMobile: boolean }) {
  return (
    <>
      ...
      <div
        className="landing-hero-illust-projector"
        style={{
          position: 'relative',
          width: isMobile
            ? 'clamp(120px, 36vw, 180px)'
            : 'clamp(110px, 14vw, 175px)',
          aspectRatio: '10 / 4.2',
          zIndex: 5,
      ...
      >
        <div
          style={{
            ...
            bottom: 0,
            background:
              'linear-gradient(to bottom, #1c1c24 0%, #111118 30%, #08080e 70%, #040408 100%)',
            borderRadius: '0 0 50% 50% / 0 0 24% 24%',
            boxShadow:
              'inset 8px 0 24px rgba(255,255,255,0.05),inset -8px 0 24px rgba(0,0,0,0.5),inset 0 -14px 30px rgba(0,0,0,0.8),inset 0 3px 8px rgba(255,255,255,0.03)',
            overflow: 'hidden',
          }}
        >
          <div
        ...
        <div
          style={{
            ...
            height: '44%',
            background:
              'radial-gradient(ellipse at 46% 36%, #28282e 0%, #181820 45%, #0c0c14 80%, #060610 100%)',
            borderRadius: '50%',
            zIndex: 2,
            boxShadow:
              'inset 0 10px 24px rgba(255,255,255,0.06),inset 0 -6px 16px rgba(0,0,0,0.7),0 8px 24px rgba(0,0,0,0.7)',
          }}
        >
          <div
            style={{
              ...
              borderRadius: '50%',
              boxShadow:
                'inset 0 0 0 1.5px rgba(255,255,255,0.06), inset 0 0 12px rgba(0,0,0,0.7)',
            }}
          />
          <div
            style={{
              ...
              borderRadius: '50%',
              background:
                'radial-gradient(ellipse at 50% 42%, #1a1a22 0%, #0a0a12 100%)',
              boxShadow:
                'inset 0 6px 16px rgba(0,0,0,0.95), inset 0 0 0 1px rgba(255,255,255,0.03)',
            }}
          />
          <div
            style={{
              ...
              borderRadius: '50%',
              background: 'transparent',
              animation: 'pp-lens-pulse 2.6s ease-in-out infinite',
            }}
          />
          <div
            style={{
              ...
              bottom: '22%',
              borderRadius: '50%',
              boxShadow: '0 0 0 2px rgba(27,46,90,0.5)',
              animation: 'pp-ring-out 2.6s ease-out infinite',
              pointerEvents: 'none',
            }}
          />
          <div
            style={{
              ...
              bottom: '22%',
              borderRadius: '50%',
              boxShadow: '0 0 0 1.5px rgba(27,46,90,0.3)',
              animation: 'pp-ring-out 2.6s ease-out 1.3s infinite',
              pointerEvents: 'none',
            }}
          />
          <div
            style={{
              ...
              borderRadius: '50%',
              background:
                'radial-gradient(circle at 44% 38%, #c8d8f0 0%, #6080b0 14%, #243b6e 38%, #1b2e5a 65%, #0f1b3d 100%)',
          ...
          <div
            style={{
              ...
              borderRadius: '50%',
              background:
                'radial-gradient(circle, #ffffff 0%, #c8d8f8 45%, transparent 100%)',
              animation: 'pp-hotspot 2.6s ease-in-out infinite',
            }}
          />
        </div>
        <div
...
function SideAgentCard({
  ...
  if (isMobile) {
    return (
      <div
        className="landing-hero-illust-side-card"
        style={{
      ...
      >
        ...
        {feeds.slice(0, 2).map((f, i) => (
          <div key={i} style={{ display: 'flex', gap: 2, marginBottom: 1.5 }}>
            ...
            <span style={{ ...TX('rgba(19,32,74,0.6)', 4), lineHeight: 1.3 }}>
              {f}
            </span>
          </div>
        ))}
        ...
        {feeds.map((item, i) => (
          <div
            ...
            style={{
              ...
              alignItems: 'flex-start',
              gap: 5,
              marginBottom: i < feeds.length - 1 ? 4 : 0,
            }}
          >
            <span
              style={{
...
function FloorGlow() {
  return (
    <>
      <div
        className="landing-hero-floor-glow pointer-events-none absolute right-0 bottom-0 left-0 z-[1] h-[280px]"
        style={{ animation: 'pp-floor-pulse 3.5s ease-in-out infinite' }}
      />
      <div
        className="pointer-events-none absolute bottom-0 left-1/2 z-[2] h-[70px] w-[min(280px,36%)] -translate-x-1/2"
        style={{
          background:
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.span
          className="landing-hero-headline-line landing-hero-headline-sub block"
          initial={{ y: 14 }}
          animate={{ y: 0 }}
...
export function PetpoojaHeroSection({
  ...
  const dashboardScale =
    isMobile && typeof window !== 'undefined'
      ? Math.max(
          ...
          (window.innerWidth -
            8 -
            2 * Math.min(130, Math.max(80, 0.22 * window.innerWidth))) /
            800
        )
      : 1
  ...
  return (
    <section className="landing-hero border-border overflow-x-clip border-b">
      <div className="landing-hero-glow-subtle pointer-events-none absolute inset-x-0 top-0 z-0 h-1/2" />
      ...
      >
        ...
        >
          {SIDE_LEFT.map((card) => (
            <SideAgentCard key={card.source} {...card} isMobile={isMobile} />
          ))}
        </motion.div>
        ...
        <div
          style={{
            ...
            flexDirection: 'column',
            alignItems: 'center',
            gap: isMobile ? 8 : 'clamp(8px, 1.5vw, 16px)',
          }}
        >
          ...
          <div
            style={{
              width: isMobile
                ? 'clamp(90px, 22vw, 160px)'
                : 'clamp(180px, 24vw, 300px)',
              height: PUCK_H,
              flexShrink: 0,
            }}
          />
