...
export function UserDetailSheet({
  ...
  return (
    <>
              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                      ...
                      <Button
                        ...
                        onClick={() => onUpdateProfile(selectedUserId, { phone: detailPhoneDraft.trim() })}
                      >
                        {updateProfileIsPending && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                        Save phone
                      </Button>
                ...
                <div>
                  <div className="mb-3 flex items-center justify-between">
                    ...
                    <Button size="sm" variant="outline" className="rounded-lg" onClick={() => onOpenRoleSheet(selectedUserId)}>
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Button
                                ...
                                onClick={() => onRemoveRoleAssignment(selectedUserId, (ra.assignmentId ?? ra.id)!)}
                              >
                                <Trash2 className="h-4 w-4" />
                              </Button>
                            </TooltipTrigger>
                ...
                <div className="flex flex-col gap-2">
                  <Button
                    ...
                    onClick={() => onUpdateStatus(selectedUserId, ud.isActive === false)}
      ...
      <AlertDialog open={!!membershipRemoveTarget} onOpenChange={(open) => !open && onSetMembershipRemoveTarget(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
          ...
          <AlertDialogFooter>
            ...
            <Button
              ...
              onClick={() => {
                ...
                onRemoveOrganizationMembership(selectedUserId, membershipRemoveTarget.membershipId)
              }}
            >
              {removeMembershipIsPending && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
              Remove assignment
            </Button>
          </AlertDialogFooter>
        </AlertDialogContent>
...
export function AssignRoleSheet({
  ...
  return (
    <Sheet open={!!roleSheetUserId} onOpenChange={(open) => { if (!open) onCancel() }}>
      <SheetContent className="flex w-full flex-col gap-0 overflow-y-auto px-6 pb-10 pt-5 sm:max-w-2xl sm:px-8 lg:max-w-3xl">
        <SheetHeader className="space-y-2 p-0 pb-5 pr-12 text-left sm:pr-14">
        ...
        <div className="space-y-5">
          ...
          <div className="flex items-center justify-between rounded-lg border p-4">
            ...
            <Switch checked={assignIsTemporary} onCheckedChange={onAssignIsTemporaryChange} />
          </div>
          ...
          <div className="flex gap-3">
            <Button variant="outline" className="flex-1 rounded-lg" onClick={onCancel}>
              Cancel
            </Button>
            <Button
...
export function RemoveUserDialog({
  ...
  return (
    <AlertDialog open={!!removeDialogUserId} onOpenChange={(open) => !open && onOpenChange(false)}>
      <AlertDialogContent>
        <AlertDialogHeader>
