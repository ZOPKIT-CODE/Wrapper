...
const AdminDashboard: React.FC = () => {
  ...
  const [tenantEntityTab, setTenantEntityTab] = useState<
    'tenants' | 'entities'
  >('tenants')
  ...
  if (loading) {
    return (
      <Container className="dashboard-actionable-cursors flex min-h-[400px] items-center justify-center">
  ...
  return (
    <Container className="dashboard-actionable-cursors">
      <div className="mb-6 rounded-2xl bg-gradient-to-br from-[#11254d] via-[#1B2E5A] to-[#0f1f40] p-6 text-white shadow-2xl">
      ...
      >
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {stats?.creditStats.totalCredits.toFixed(2) || '0.00'}
                </div>
                <p className="text-muted-foreground text-xs">
                  {stats?.creditStats.totalReserved.toFixed(2) || '0.00'}{' '}
                  reserved
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-red-600">
                  {stats?.creditStats.lowBalanceAlerts || 0}
                </div>
                <p className="text-muted-foreground text-xs">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Latest changes across all tenants
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="tenants-entities" className="space-y-4">
          <Tabs
            value={tenantEntityTab}
            onValueChange={(value) =>
              setTenantEntityTab(value as 'tenants' | 'entities')
            }
          >
