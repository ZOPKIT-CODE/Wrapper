...
export class EntityAdminService {
  ...
  static async getEntityList(filters: Record<string, unknown> = {}, pagination: Record<string, unknown> = {}): Promise<Record<string, unknown>> {
    try {
      ...
      Logger.log('error', 'general', 'get-entity-list', 'Error getting entity list', { error: error.message });
      throw error;
    }
  }
  ...
  static async getEntityCount(filters: Record<string, unknown> = {}): Promise<number> {
    try {
      ...
      const error = err as Error;
      Logger.log('error', 'general', 'get-entity-count', 'Error getting entity count', { error: error.message });
      throw error;
    }
  }
  ...
  static async getTenantEntities(tenantId: string, entityType: string | null = null): Promise<Record<string, unknown>> {
    try {
      ...
      const error = err as Error;
      Logger.log('error', 'general', 'get-tenant-entities', 'Error getting tenant entities', { error: error.message });
      throw error;
    }
  }
  ...
  static async getEntityDetails(entityId: string): Promise<Record<string, unknown>> {
    try {
      ...
      const error = err as Error;
      Logger.log('error', 'general', 'get-entity-details', 'Error getting entity details', { error: error.message });
      throw error;
    }
  }
  ...
  static async getEntityHierarchy(tenantId: string): Promise<Record<string, unknown>> {
    try {
      ...
      const error = err as Error;
      Logger.log('error', 'general', 'get-entity-hierarchy', 'Error getting entity hierarchy', { error: error.message });
      throw error;
    }
  }
  ...
  static async updateEntityStatus(entityId: string, isActive: boolean, reason: string | null = null, adminUserId: string | null = null): Promise<Record<string, unknown>> {
    try {
      ...
      Logger.log('info', 'general', 'update-entity-status', 'Entity status updated by admin', { entityId, isActive, adminUserId, reason });

      return { success: true };
    } catch (err: unknown) {
      const error = err as Error;
      Logger.log('error', 'general', 'update-entity-status', 'Error updating entity status', { error: error.message });
      throw error;
    }
  }
  ...
  static async bulkUpdateEntityStatus(entityIds: string[], isActive: boolean, reason: string | null = null, adminUserId: string | null = null): Promise<Record<string, unknown>> {
    try {
      ...
      Logger.log('info', 'general', 'bulk-update-entity-status', 'Bulk entity status updated by admin', { count: entityIds.length, isActive, adminUserId, reason });
      ...
      const error = err as Error;
      Logger.log('error', 'general', 'bulk-update-entity-status', 'Error bulk updating entity status', { error: error.message });
      throw error;
    }
  }
  ...
  static async getEntityStatsOverview(): Promise<Record<string, unknown>> {
    try {
      ...
      const error = err as Error;
      Logger.log('error', 'general', 'get-entity-stats-overview', 'Error getting entity stats overview', { error: error.message });
      throw error;
    }
  }
  ...
  static async searchEntities(query: string, filters: Record<string, unknown> = {}): Promise<Record<string, unknown>> {
    try {
      ...
      const error = err as Error;
      Logger.log('error', 'general', 'search-entities', 'Error searching entities', { error: error.message });
      throw error;
    }
  }
  ...
  static async buildEntityHierarchy(entityId: string): Promise<Array<{ entityId: string; entityName: string | null; entityType: string | null }>> {
    try {
      ...
      const error = err as Error;
      Logger.log('error', 'general', 'build-entity-hierarchy', 'Error building entity hierarchy', { error: error.message });
      throw error;
    }
  }
  ...
  static async getChildEntities(parentEntityId: string): Promise<unknown[]> {
    try {
      ...
      const error = err as Error;
      Logger.log('error', 'general', 'get-child-entities', 'Error getting child entities', { error: error.message });
      throw error;
    }
  }
  ...
  static async getEntityStats(entityId: string): Promise<Record<string, unknown>> {
    try {
      ...
      const error = err as Error;
      Logger.log('error', 'general', 'get-entity-stats', 'Error getting entity stats', { error: error.message });
      throw error;
    }
  }
